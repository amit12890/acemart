...
return"https://".concat(a,".a.searchspring.io/api/search/autocomplete.json?siteId=").concat(a,"&q=").concat(e,"&resultsFormat=native&resultsPerPage=").concat(t)},N=function apiGetSearchResult(e){return"https://".concat(a,".a.searchspring.io/api/search/search.json?").concat(e)},R=function apiGetSearchTracker(e,t,n,r){return"https://".concat(a,".a.searchspring.io/api/track/track.json?d=").concat(e,"&s=").concat(t,"&u=").concat(n,"&r=").concat(r)},M=function storeLocatorUrl(){return"/store-locator"},D=function productSpecsheetUrl(e){return"".concat(r,"/pub/media/specsheets/").concat(e,".pdf")},F=function productSpecsheetLogoUrl(){return"".concat(r,"/pub/media/attribute/pdf-logo32px.svg.png")},z=function comingSoonImage(){return"https://cdn.acemart.com/pub/media/catalog/product/placeholder/default/Image-Coming-Soon.jpg"},q=function logoUrl(){return"".concat(o,"/logo-qeq.svg")},B=function customMapMarkerIcon(e){return"https://qa-acemart-backend.magedelight.magentoprojects.net/pub/media/maps/images/".concat(e,".png")},U=function getDefaultLatLong(){return{lat:30.071,lng:-97.90559}}},fCmd:function(e,t,n){"use strict"
