...
null!==u&&a(U,u.startTime-n),c=!1}return c}finally{k=null,x=r,j=!1}}var N=i
...
return N.lastIndex=t,null!==(n=N.exec(e)[1])&&void 0!==n?n:""}}else k=function matchIdentifierAtIndex(e,t){for(var n=[];;){var r=j(e,t)
...
var jt={"\\":"\\","'":"'","\n":"n","\r":"r","\u2028":"u2028","\u2029":"u2029"},Ct=parseFloat,At=parseInt,Nt="object"==typeof e&&e&&e.Object===Object&&e,Lt="object"==typeof self&&self&&self.Object===Object&&self,Pt=Nt||Lt||Function("return this")(),Mt=t&&!t.nodeType&&t,Rt=Mt&&"object"==typeof r&&r&&!r.nodeType&&r,Dt=Rt&&Rt.exports===Mt,Ft=Dt&&Nt.process,qt=function(){try{var e=Rt&&Rt.require&&Rt.require("util").types
...
this.size=t.size}function arrayLikeKeys(e,t){var n=Nr(e),r=!n&&Ar(e),a=!n&&!r&&Pr(e),o=!n&&!r&&!a&&qr(e),i=n||r||a||o,s=i?baseTimes(e.length,nt):[],c=s.length
...
if(p){var d=Nr(u),h=!d&&Pr(u),m=!d&&!h&&qr(u)
...
return baseIsNative(n)?n:o}var Un=tn?function(e){return null==e?[]:(e=et(e),arrayFilter(tn(e),function(t){return Nt.call(e,t)}))}:stubArray,zn=tn?function(e){for(var t=[];e;)arrayPush(t,Un(e)),e=Ot(e)
...
e=e[i]}return o||++r!=a?o:!!(a=null==e?0:e.length)&&isLength(a)&&isIndex(i,a)&&(Nr(e)||Ar(e))}function initCloneObject(e){return"function"!=typeof e.constructor||isPrototype(e)?{}:jn(Ot(e))}function isFlattenable(e){return Nr(e)||Ar(e)||!!(Mt&&e&&e[Mt])}function isIndex(e,t){var n=typeof e
...
function forEach(e,t){return(Nr(e)?arrayEach:Cn)(e,getIteratee(t,3))}function forEachRight(e,t){return(Nr(e)?arrayEachRight:An)(e,getIteratee(t,3))}var mr=createAggregator(function(e,t,n){ut.call(e,n)?e[n].push(t):baseAssignValue(e,n,[t])})
...
var kr=Rn(function(e,t){var n=(t=1==t.length&&Nr(t[0])?arrayMap(t[0],baseUnary(getIteratee())):arrayMap(baseFlatten(t,1),baseUnary(getIteratee()))).length
...
function eq(e,t){return e===t||e!=e&&t!=t}var jr=createRelationalOperation(baseGt),Cr=createRelationalOperation(function(e,t){return e>=t}),Ar=baseIsArguments(function(){return arguments}())?baseIsArguments:function(e){return isObjectLike(e)&&ut.call(e,"callee")&&!Nt.call(e,"callee")},Nr=n.isArray,Lr=Ut?baseUnary(Ut):function baseIsArrayBuffer(e){return isObjectLike(e)&&baseGetTag(e)==ue}
...
function isString(e){return"string"==typeof e||!Nr(e)&&isObjectLike(e)&&baseGetTag(e)==ae}function isSymbol(e){return"symbol"==typeof e||isObjectLike(e)&&baseGetTag(e)==oe}var qr=Vt?baseUnary(Vt):function baseIsTypedArray(e){return isObjectLike(e)&&isLength(e.length)&&!!It[baseGetTag(e)]}
...
return(n-=t.length)>=0&&e.slice(n,a)==t},lodash.eq=eq,lodash.escape=function escape(e){return(e=toString(e))&&xe.test(e)?e.replace(Se,Jt):e},lodash.escapeRegExp=function escapeRegExp(e){return(e=toString(e))&&Pe.test(e)?e.replace(Le,"\\$&"):e},lodash.every=function every(e,t,n){var r=Nr(e)?arrayEvery:baseEvery
...
if(!r)return-1
var a=null==n?0:toInteger(n)
return a<0&&(a=sn(r+a,0)),baseIndexOf(e,t,a)},lodash.inRange=function inRange(e,t,n){return t=toFinite(t),n===o?(n=t,t=0):n=toFinite(n),function baseInRange(e,t,n){return e>=cn(t,n)&&e<sn(t,n)}(e=toNumber(e),t,n)},lodash.invoke=Yr,lodash.isArguments=Ar,lodash.isArray=Nr,lodash.isArrayBuffer=Lr,lodash.isArrayLike=isArrayLike,lodash.isArrayLikeObject=isArrayLikeObject,lodash.isBoolean=function isBoolean(e){return!0===e||!1===e||isObjectLike(e)&&baseGetTag(e)==V},lodash.isBuffer=Pr,lodash.isDate=Mr,lodash.isElement=function isElement(e){return isObjectLike(e)&&1===e.nodeType&&!isPlainObject(e)},lodash.isEmpty=function isEmpty(e){if(null==e)return!0
if(isArrayLike(e)&&(Nr(e)||"string"==typeof e||"function"==typeof e.splice||Pr(e)||qr(e)||Ar(e)))return!e.length
var t=Bn(e)
...
return cn(e+a*(t-e+Ct("1e-"+((a+"").length-1))),t)}return baseRandom(e,t)},lodash.reduce=function reduce(e,t,n){var r=Nr(e)?arrayReduce:baseReduce,a=arguments.length<3
return r(e,getIteratee(t,4),n,a,Cn)},lodash.reduceRight=function reduceRight(e,t,n){var r=Nr(e)?arrayReduceRight:baseReduce,a=arguments.length<3
...
i===o&&(r=a,i=n),e=isFunction(i)?i.call(e):i}return e},lodash.round=ja,lodash.runInContext=runInContext,lodash.sample=function sample(e){return(Nr(e)?arraySample:baseSample)(e)},lodash.size=function size(e){if(null==e)return 0
if(isArrayLike(e))return isString(e)?stringSize(e):e.length
var t=Bn(e)
return t==Y||t==re?e.size:baseKeys(e).length},lodash.snakeCase=ca,lodash.some=function some(e,t,n){var r=Nr(e)?arraySome:baseSome
...
return t.error?e:u()({},e,{prevPageTotal:n})}),o),C=Object(l.a)(j,{categories:{},currentPage:1,pageSize:6,prevPageTotal:null}),A=n("+X85"),N={availableShippingMethods:[],billingAddress:null,billingAddressError:null,isSubmitting:!1,orderError:null,paymentMethodError:null,paymentCode:"",paymentData:null,receipt:{order:{}},shippingAddress:{},shippingAddressError:null,shippingMethod:"",shippingMethodError:null,shippingTitle:""},L=(x={},s()(x,A.a.begin,function(e,t){var n=t.payload
...
return u()({},e,{receipt:{order:n}})}),s()(x,A.a.receipt.reset,function(e){return u()({},e,{receipt:u()({},N.receipt)})}),s()(x,A.a.shippingMethod.submit,function(e){return u()({},e,{isSubmitting:!0,shippingMethodError:null})}),s()(x,A.a.shippingMethod.accept,function(e,t){var n=t.payload
...
n.d(t,"a",function(){return r}),n.d(t,"b",function(){return a}),n.d(t,"y",function(){return o}),n.d(t,"L",function(){return i}),n.d(t,"w",function(){return s}),n.d(t,"d",function(){return c}),n.d(t,"r",function(){return u}),n.d(t,"s",function(){return l}),n.d(t,"B",function(){return f}),n.d(t,"C",function(){return p}),n.d(t,"A",function(){return d}),n.d(t,"z",function(){return h}),n.d(t,"D",function(){return m}),n.d(t,"f",function(){return g}),n.d(t,"e",function(){return v}),n.d(t,"t",function(){return b}),n.d(t,"p",function(){return y}),n.d(t,"n",function(){return _}),n.d(t,"I",function(){return E}),n.d(t,"J",function(){return w}),n.d(t,"k",function(){return O}),n.d(t,"g",function(){return S}),n.d(t,"l",function(){return k}),n.d(t,"j",function(){return x}),n.d(t,"h",function(){return I}),n.d(t,"i",function(){return T}),n.d(t,"q",function(){return j}),n.d(t,"x",function(){return C}),n.d(t,"H",function(){return A}),n.d(t,"K",function(){return N}),n.d(t,"c",function(){return L}),n.d(t,"m",function(){return P}),n.d(t,"N",function(){return M}),n.d(t,"u",function(){return R}),n.d(t,"M",function(){return D}),n.d(t,"G",function(){return F}),n.d(t,"v",function(){return q}),n.d(t,"o",function(){return U}),n.d(t,"F",function(){return z}),n.d(t,"E",function(){return B})
...
return i.delete(e),T
case k:if(j)return j.call(e)==j.call(t)}return!1},A=n("TFwu"),N=1,L=Object.prototype.hasOwnProperty
var P=function equalObjects(e,t,n,r,a,o){var i=n&N,s=Object(A.a)(e),c=s.length
if(c!=Object(A.a)(t).length&&!i)return!1
for(var u=c;u--;){var l=s[u]
if(!(i?l in t:L.call(t,l)))return!1}var f=o.get(e),p=o.get(t)
...
try{return t(a,i).of(n)}catch(e){o(new _e.a(_e.b.FORMAT_ERROR,"Error formatting display name.",e))}}function verifyConfigMessages(e){e.defaultRichTextElements&&function messagesContainString(e){return"string"==typeof(e?e[Object.keys(e)[0]]:void 0)}(e.messages||{})}var Ae,Ne=n("6koa"),Le=n.n(Ne),Pe=n("/d+U"),Me=(Ae=function(e,t){return(Ae=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var n in t)t.hasOwnProperty(n)&&(e[n]=t[n])})(e,t)},function(e,t){function __(){this.constructor=e}Ae(e,t),e.prototype=null===t?Object.create(t):(__.prototype=t.prototype,new __)}),Re=function(){return(Re=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++)for(var a in t=arguments[n])Object.prototype.hasOwnProperty.call(t,a)&&(e[a]=t[a])
return e}).apply(this,arguments)},De=function(e,t){var n={}
for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r])
if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var a=0
for(r=Object.getOwnPropertySymbols(e);a<r.length;a++)t.indexOf(r[a])<0&&Object.prototype.propertyIsEnumerable.call(e,r[a])&&(n[r[a]]=e[r[a]])}return n},Fe=Le.a||Ne
...
var Rt=Mt,Dt=n("v5OO"),Ft=n("JpXh"),qt=n("AUXF"),Ut=n("drvu"),zt=n("oTwF"),Bt=n("/tQY"),Wt=n.n(Bt),Ht={injectType:"singletonStyleTag",insert:"head",singleton:!0},Vt=(at()(Wt.a,Ht),Wt.a.locals||{}),Gt=a.a.lazy(function(){return Promise.all([n.e(0),n.e(8),n.e(10),n.e(13),n.e(67)]).then(n.bind(null,"Dp9e"))}),Kt=function AccountTrigger(e){var t,n=function useAccountTrigger(){var e=Object(Ft.a)(),t=e.elementRef,n=e.expanded,a=e.setExpanded,o=e.triggerRef,i=Object(r.useCallback)(function(){a(function(e){return!e})},[a])
...
var Qt,Xt=n("9872"),Yt=["/checkout"],$t=n("4ARJ"),Zt=n.n($t),en={injectType:"singletonStyleTag",insert:"head",singleton:!0},tn=(at()(Zt.a,en),Zt.a.locals||{}),nn=n("ZqKV"),rn=Object(S.gql)(Qt||(Qt=he()(["\n    query getItemCount($cartId: String!) {\n        cart(cart_id: $cartId) {\n            id\n            ...CartTriggerFragment\n        }\n    }\n    ","\n"])),nn.a),an=a.a.lazy(function(){return Promise.all([n.e(0),n.e(4),n.e(52)]).then(n.bind(null,"ZrgV"))}),on=function CartTrigger(e){var t=function useCartTrigger(e){var t=e.queries.getItemCountQuery,n=Object(Xt.b)(),a=N()(n,1)[0].cartId,o=Object(Ft.a)(),i=o.elementRef,s=o.expanded,c=o.setExpanded,u=o.triggerRef,l=Object(Ye.g)(),f=Object(S.useQuery)(t,{fetchPolicy:"cache-and-network",nextFetchPolicy:"cache-first",variables:{cartId:a},skip:!a}).data,p=f?f.cart.total_quantity:0,d=Yt.includes(l.location.pathname),h=Object(r.useCallback)(function(){c(function(e){return!e})},[c])
...
var cn=n("RhW5"),un=n("GRmw"),ln=n.n(un),fn={injectType:"singletonStyleTag",insert:"head",singleton:!0},pn=(at()(ln.a,fn),ln.a.locals||{}),dn=function NavigationTrigger(e){var t=Object(Ke.a)().formatMessage,n=function useNavigationTrigger(){var e=Object(Ze.b)(),t=N()(e,2)[1].toggleDrawer
...
var cr=function Autocomplete(e){var t=e.setVisible,n=e.valid,o=e.visible,i=function useAutocomplete(e){var t=e.valid,n=e.visible,a=Object(jn.m)("search_query").value,o=Object(Ln.a)({isLazy:!0,headers:{}}),i=o.callApi,s=g()(o,Pn),c=Object(Ln.a)({isLazy:!0,headers:{}}),u=c.callApi,l=g()(c,Mn),f=Object(r.useMemo)(function(){return Nn()(function(e){i(Object(Et.j)(e)),u(Object(Et.h)(e))},1e3)},[])
Object(r.useEffect)(function(){t&&n&&f(a)},[f,t,a,n])
var p=s.loading,d=l.loading,h=p||d,m=s.response,b=l.response,y=Object(v.get)(m,"query",""),_=y&&y!==a,E=Object(v.size)(m)||Object(v.size)(b),w=!(!t||!E||h||_)
return{suggestionLoading:p,productLoading:d,suggestions:m,products:b,messageType:"",value:a,displayResult:w,isLoading:t&&!w}}({valid:n,visible:o}),s=i.suggestions,c=i.products,u=i.displayResult,l=i.isLoading,f=Object(pt.a)(qn,e.classes),p=u&&o&&(!!Object(v.get)(c,"results.length")||!!Object(v.get)(s,"alternatives.length"))?f.root_visible:l?f.root_loading:f.root_hidden
...
var lr=n("wHH0"),fr=n("wWq3"),pr=n("IOPv"),dr=n("ICak"),hr=n("bNDk"),mr=n("YmET"),gr=n.n(mr),vr={injectType:"singletonStyleTag",insert:"head",singleton:!0},br=(at()(gr.a,vr),gr.a.locals||{}),yr=a.a.createElement(zt.a,{src:lr.a,size:24}),_r=a.a.createElement(zt.a,{src:fr.a,size:24}),Er=function SearchField(e){var t=Object(pt.a)(br),n=e.isSearchOpen,o=e.onChange,i=e.onFocus,s=function useSearchField(e){var t=e.isSearchOpen,n=Object(r.useRef)(),a=Object(jn.m)("search_query").value,o=Object(jn.n)(),i=Object(r.useCallback)(function(){o.reset()},[o])
return Object(r.useEffect)(function(){t&&n.current&&n.current.focus()},[t]),Object(r.useEffect)(function(){var e=Object(pr.a)("query",location)
o&&e&&o.setValue("search_query",e)},[]),{inputRef:n,resetForm:i,value:a}}({isSearchOpen:n}),c=s.inputRef,u=s.resetForm,l=s.value,f=l?a.a.createElement(hr.a,{action:u},yr):null
return a.a.createElement(dr.a,{after:l?f:_r,field:"search_query",onFocus:i,onValueChange:o,forwardedRef:c,classes:{input:t.searchTextInput},placeholder:"Search Ace Mart"})},wr=Er
Er.propTypes={onChange:Je.func,onFocus:Je.func}
var Or=n("EOE6"),Sr=n.n(Or),kr={injectType:"singletonStyleTag",insert:"head",singleton:!0},xr=(at()(Sr.a,kr),Sr.a.locals||{}),Ir=a.a.forwardRef(function(e,t){var n=e.isOpen,o=function useSearchBar(){var e=Object(r.useState)(!1),t=N()(e,2),n=t[0],a=t[1],o=Object(Ft.a)(),i=o.elementRef,s=o.expanded,c=o.setExpanded,u=Object(Ye.g)(),l=u.push
...
fa.propTypes={active:Je.bool,classes:Object(Je.shape)({content:Je.string,root:Je.string,text:Je.string}),onClick:Je.func,option:Je.string}
var pa=fa,da=n("y+6n"),ha=function(){try{return new Intl.NumberFormat(void 0,{style:"currency",currency:"USD",currencyDisplay:"narrowSymbol"}),!0}catch(e){return e.constructor,RangeError,!1}}(),ma={UAH:"₴"},ga=function CurrencySymbol(e){var t=Object(Ke.a)().locale,n=e.currencyCode,r=e.classes,o=e.currencyDisplay,i=ha?t:"en",s=ha?o:"symbol"
if(!ha&&n in ma)return a.a.createElement("span",{className:r.currency},ma[n])
var c=da.a.toParts.call(new Intl.NumberFormat(i,{style:"currency",currencyDisplay:s,currency:n}),0).find(function(e){return"currency"===e.type})
return a.a.createElement("span",{className:r.currency},c.value)}
ga.propTypes={classes:Object(Je.shape)({currency:Je.string}),currencyCode:Je.string.isRequired,currencyDisplay:Je.string},ga.defaultProps={classes:{},currencyDisplay:"symbol"}
var va=ga,ba=function CurrencySwitcher(e){var t=ta(),n=t.handleSwitchCurrency,r=t.currentCurrencyCode,o=t.availableCurrencies,i=t.currencyMenuRef,s=t.currencyMenuTriggerRef,c=t.currencyMenuIsOpen,u=t.handleTriggerClick,l=Object(pt.a)(oa,e.classes),f=c?l.menu_open:l.menu,p={currency:l.symbol}
if(!o||1===o.length)return null
var d=o.map(function(e){return a.a.createElement("li",{key:e,className:l.menuItem},a.a.createElement(pa,{active:e===r,onClick:n,option:e},a.a.createElement(va,{classes:p,currencyCode:e,currencyDisplay:"narrowSymbol"}),e))})
return a.a.createElement("div",{className:l.root},a.a.createElement("button",{className:l.trigger,"aria-label":r,onClick:u,ref:s},a.a.createElement("span",{className:l.label},a.a.createElement(va,{classes:p,currencyCode:r,currencyDisplay:"narrowSymbol"}),r)),a.a.createElement("div",{ref:i,className:f},a.a.createElement("ul",null,d)))},ya=ba
ba.propTypes={classes:Object(Je.shape)({root:Je.string,trigger:Je.string,menu:Je.string,menu_open:Je.string,menuItem:Je.string,symbol:Je.string})}
var _a,Ea=n("Ddd9"),wa=n.n(Ea),Oa=n("xNr4"),Sa=n.n(Oa),ka={getMegaMenuQuery:Object(S.gql)(_a||(_a=he()(["\n    query getMegaMenu {\n        categoryList {\n            id\n            name\n            children {\n                id\n                include_in_menu\n                name\n                position\n                url_path\n                url_suffix\n                canonical_url\n                children {\n                    id\n                    include_in_menu\n                    name\n                    position\n                    url_path\n                    url_suffix\n                    canonical_url\n                    children {\n                        id\n                        include_in_menu\n                        name\n                        position\n                        url_path\n                        url_suffix\n                        canonical_url\n                    }\n                }\n            }\n        }\n    }\n"])))},xa=n("t96/"),Ia=n.n(xa),Ta={injectType:"singletonStyleTag",insert:"head",singleton:!0},ja=(at()(Ia.a,Ta),Ia.a.locals||{}),Ca=n("9H39"),Aa=n.n(Ca),Na={injectType:"singletonStyleTag",insert:"head",singleton:!0},La=(at()(Aa.a,Na),Aa.a.locals||{}),Pa=n("adaq"),Ma=n.n(Pa),Ra={injectType:"singletonStyleTag",insert:"head",singleton:!0},Da=(at()(Ma.a,Ra),Ma.a.locals||{}),Fa=n("EAKA"),qa=n("R7GM"),Ua=n.n(qa),za={injectType:"singletonStyleTag",insert:"head",singleton:!0},Ba=(at()(Ua.a,za),Ua.a.locals||{}),Wa=function SubmenuColumn(e){var t=e.category,n=Object(pt.a)(Ba,e.classes),r=Object(wn.a)("/".concat(t.canonical_url).concat(t.url_suffix||"")),o=null
...
o=a.a.createElement("ul",{className:n.submenuChild},i)}return a.a.createElement("div",{className:n.submenuColumn},a.a.createElement(x.b,{className:n.link,to:r},a.a.createElement("h3",{className:n.heading},t.name),a.a.createElement(Fa.a,null)),o)},Ha=Wa
Wa.propTypes={category:Qe.a.shape({children:Qe.a.array,id:Qe.a.number.isRequired,include_in_menu:Qe.a.number,isActive:Qe.a.bool.isRequired,name:Qe.a.string.isRequired,path:Qe.a.array.isRequired,position:Qe.a.number.isRequired,url_path:Qe.a.string.isRequired,url_suffix:Qe.a.string}).isRequired}
var Va=function Submenu(e){var t=e.items,n=(e.mainNavWidth,Object(pt.a)(Da,e.classes)),r=t.map(function(e){return a.a.createElement(Ha,{category:e,key:e.id})})
return a.a.createElement("div",{className:n.submenu},a.a.createElement("div",{className:n.submenuItems},r))},Ga=Va
Va.propTypes={items:Qe.a.arrayOf(Qe.a.shape({children:Qe.a.array.isRequired,id:Qe.a.number.isRequired,include_in_menu:Qe.a.number.isRequired,isActive:Qe.a.bool.isRequired,name:Qe.a.string.isRequired,path:Qe.a.array.isRequired,position:Qe.a.number.isRequired,url_path:Qe.a.string.isRequired,url_suffix:Qe.a.string})).isRequired,mainNavWidth:Qe.a.number.isRequired}
var Ka=function MegaMenuItem(e){var t=e.activeCategoryId,n=e.category,r=e.mainNavWidth,o=Object(pt.a)(La,e.classes),i="specials"===n.canonical_url?Object(wn.a)("".concat(Object(Et.J)(),"?q=").concat(n.canonical_url)):Object(wn.a)("/".concat(n.canonical_url).concat(n.url_suffix||"")),s=n.children.length?a.a.createElement(Ga,{items:n.children,mainNavWidth:r}):null,c=n.id===t
return a.a.createElement("div",{className:o.megaMenuItem},a.a.createElement(x.b,{className:c?o.megaMenuLinkActive:o.megaMenuLink,to:i},n.name),s)},Ja=Ka
Ka.propTypes={category:Qe.a.shape({children:Qe.a.array,id:Qe.a.number.isRequired,include_in_menu:Qe.a.number,isActive:Qe.a.bool.isRequired,name:Qe.a.string.isRequired,path:Qe.a.array.isRequired,position:Qe.a.number.isRequired,url_path:Qe.a.string,url_suffix:Qe.a.string}).isRequired,activeCategoryId:Qe.a.number,mainNavWidth:Qe.a.number.isRequired}
var Qa=function MegaMenu(e){var t=function useMegaMenu(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},t=Object(pt.a)(ka,e.operations).getMegaMenuQuery,n=Object(Ye.h)(),a=Object(r.useState)(null),o=N()(a,2),i=o[0],s=o[1],c=Object(S.useQuery)(t,{fetchPolicy:"cache-and-network",nextFetchPolicy:"cache-first"}).data,u=Object(r.useCallback)(function(e){var t=e.url_path,r=e.url_suffix
if(!t)return!1
...
s(e?e.path[0]:null)},[p,n.pathname,f]),{megaMenuData:f,activeCategoryId:i}}(),n=t.megaMenuData,o=t.activeCategoryId,i=Object(pt.a)(ja,e.classes),s=Object(r.useRef)(null),c=Object(r.useState)(0),u=N()(c,2),l=u[0],f=u[1]
...
var p=n.children?n.children.map(function(e){return a.a.createElement(Ja,{category:e,activeCategoryId:o,mainNavWidth:l,key:e.id})}):null
return a.a.createElement("nav",{ref:s,className:i.megaMenu,role:"navigation"},p)},Xa=function Header(e){var t=function useHeader(){var e=Object(Ze.b)(),t=N()(e,1)[0],n=t.hasBeenOffline,a=t.isOnline,o=t.isPageLoading,i=Object(Ft.a)(),s=i.elementRef,c=i.expanded,u=i.setExpanded,l=i.triggerRef
...
return c?null:a.a.createElement("li",{className:i.root},a.a.createElement("button",{className:i.target,type:"button",onClick:u},a.a.createElement("span",{className:i.text},o)))},Ho=Wo
Wo.propTypes={category:Object(Je.shape)({id:Je.number.isRequired,include_in_menu:Je.number,name:Je.string.isRequired}).isRequired,classes:Object(Je.shape)({root:Je.string,target:Je.string,text:Je.string}),setCategoryId:Je.func.isRequired}
var Vo=n("4eMK"),Go=n.n(Vo),Ko={injectType:"singletonStyleTag",insert:"head",singleton:!0},Jo=(at()(Go.a,Ko),Go.a.locals||{}),Qo=function Leaf(e){var t=e.category,n=e.onNavigate,o=t.name,i=t.url_path,s=t.url_suffix,c=t.children,u=Object(pt.a)(Jo,e.classes),l=function useCategoryLeaf(e){var t=e.onNavigate
return{handleClick:Object(r.useCallback)(function(){t()},[t])}}({onNavigate:n}).handleClick,f=Object(wn.a)("/".concat(i).concat(s||"")),p=c&&c.length?a.a.createElement(wo.a,{id:"categoryLeaf.allLabel",defaultMessage:"All {name}",values:{name:o}}):o
return a.a.createElement("li",{className:u.root},a.a.createElement(x.b,{className:u.target,to:f,onClick:l},a.a.createElement("span",{className:u.text},p)))},Xo=Qo
Qo.propTypes={category:Object(Je.shape)({name:Je.string.isRequired,url_path:Je.string.isRequired}).isRequired,classes:Object(Je.shape)({root:Je.string,target:Je.string,text:Je.string}),onNavigate:Je.func.isRequired}
var Yo=n("Wzib"),$o=n.n(Yo),Zo={injectType:"singletonStyleTag",insert:"head",singleton:!0},ei=(at()($o.a,Zo),$o.a.locals||{}),ti=function Tree(e){var t=e.categoryId,n=e.onNavigate,o=e.setCategoryId,i=function useCategoryTree(e){var t=e.categoryId,n=e.updateCategories,a=Object(pt.a)(Fo,e.operations).getNavigationMenuQuery,o=Object(S.useLazyQuery)(a,{fetchPolicy:"cache-and-network",nextFetchPolicy:"cache-first"}),i=N()(o,2),s=i[0],c=i[1].data
...
e.set(t.id,{category:t,isLeaf:n})}}),e},[f,u]),data:c}}({categoryId:t,updateCategories:e.updateCategories}),s=i.data,c=i.childCategories,u=Object(pt.a)(ei,e.classes),l=s?Array.from(c,function(e){var t=N()(e,2),r=t[0],i=t[1],s=i.category
return i.isLeaf?a.a.createElement(Xo,{key:r,category:s,onNavigate:n}):a.a.createElement(Ho,{key:r,category:s,setCategoryId:o})}):null
return a.a.createElement("div",{className:u.root},a.a.createElement("ul",{className:u.tree},l))},ni=ti
ti.propTypes={categoryId:Je.number,classes:Object(Je.shape)({root:Je.string,tree:Je.string}),onNavigate:Je.func.isRequired,setCategoryId:Je.func.isRequired,updateCategories:Je.func.isRequired}
var ri=n("zdpc"),ai=n.n(ri),oi={injectType:"singletonStyleTag",insert:"head",singleton:!0},ii=(at()(ai.a,oi),ai.a.locals||{}),si=n("Lh/v"),ci=n.n(si),ui={injectType:"singletonStyleTag",insert:"head",singleton:!0},li=(at()(ci.a,ui),ci.a.locals||{}),fi=function SwitcherItem(e){var t=e.active,n=e.onClick,o=e.option,i=e.children,s=Object(pt.a)(li,e.classes),c=Object(r.useCallback)(function(){n(o)},[o,n]),u=t?a.a.createElement(zt.a,{size:20,src:ia.a}):null
return a.a.createElement("button",{className:s.root,disabled:t,onClick:c},a.a.createElement("span",{className:s.content},a.a.createElement("span",{className:s.text},i),u))}
fi.propTypes={active:Je.bool,classes:Object(Je.shape)({content:Je.string,root:Je.string,text:Je.string}),onClick:Je.func,option:Je.string}
var pi=fi,di=function CurrencySwitcher(e){var t=ta(),n=t.handleSwitchCurrency,r=t.currentCurrencyCode,o=t.availableCurrencies,i=t.currencyMenuRef,s=t.currencyMenuTriggerRef,c=t.currencyMenuIsOpen,u=t.handleTriggerClick,l=Object(pt.a)(ii,e.classes),f=c?l.menu_open:l.menu,p={currency:l.symbol}
if(!o||1===o.length)return null
var d=o.map(function(e){return a.a.createElement("li",{key:e,className:l.menuItem},a.a.createElement(pi,{active:e===r,onClick:n,option:e},a.a.createElement(va,{classes:p,currencyCode:e,currencyDisplay:"narrowSymbol"}),e))})
return a.a.createElement("div",{className:l.root},a.a.createElement("button",{className:l.trigger,"aria-label":r,onClick:u,ref:s},a.a.createElement("span",{className:l.label},a.a.createElement(va,{classes:p,currencyCode:r,currencyDisplay:"narrowSymbol"}),r)),a.a.createElement("div",{ref:i,className:f},a.a.createElement("ul",null,d)))},hi=di
di.propTypes={classes:Object(Je.shape)({root:Je.string,trigger:Je.string,menu:Je.string,menu_open:Je.string,menuItem:Je.string,symbol:Je.string})}
var mi=n("tvce"),gi=n("zr/2"),vi=n.n(gi),bi={injectType:"singletonStyleTag",insert:"head",singleton:!0},yi=(at()(vi.a,bi),vi.a.locals||{}),_i=function StoreSwitcher(e){var t=Object(mi.a)(),n=t.availableStores,r=t.currentGroupName,o=t.currentStoreName,i=t.handleSwitchStore,s=t.storeGroups,c=t.storeMenuRef,u=t.storeMenuTriggerRef,l=t.storeMenuIsOpen,f=t.handleTriggerClick,p=Object(pt.a)(yi,e.classes),d=l?p.menu_open:p.menu
...
t=g?"".concat(o):"".concat(r," - ").concat(o),n.push(a.a.createElement("li",{key:c,className:p.menuItem},a.a.createElement(pi,{active:s,onClick:i,option:c},t)))}),m.push(a.a.createElement("ul",{className:p.groupList,key:t},n))}),h=g?"".concat(o):"".concat(r," - ").concat(o),a.a.createElement("div",{className:p.root},a.a.createElement("button",{className:p.trigger,"aria-label":o,onClick:f,ref:u},h),a.a.createElement("div",{ref:c,className:d},a.a.createElement("div",{className:p.groups},m)))},Ei=_i
_i.propTypes={classes:Object(Je.shape)({groupList:Je.string,groups:Je.string,menu:Je.string,menu_open:Je.string,menuItem:Je.string,root:Je.string,trigger:Je.string})}
var wi=n("eYVk"),Oi=n("G5e0"),Si=n("j+6E"),ki=n.n(Si),xi={injectType:"singletonStyleTag",insert:"head",singleton:!0},Ii=(at()(ki.a,xi),ki.a.locals||{}),Ti=function NavHeader(e){var t,n=e.isTopLevel,o=e.onBack,i=e.view,s=Object(Ke.a)().formatMessage,c=function useNavigationHeader(e){var t=e.isTopLevel,n=e.onBack,a=e.view,o=t&&"MENU"===a
return{handleBack:Object(r.useCallback)(function(){n()},[n]),isTopLevelMenu:o}}({isTopLevel:n,onBack:o,view:i}),u=c.handleBack,l=c.isTopLevelMenu,f=Object(pt.a)(Ii,e.classes),p={CREATE_ACCOUNT:s({id:"navHeader.createAccountText",defaultMessage:"Create Account"}),FORGOT_PASSWORD:s({id:"navHeader.forgotPasswordText",defaultMessage:"Forgot Password"}),MY_ACCOUNT:s({id:"navHeader.myAccountText",defaultMessage:"My Account"}),SIGN_IN:s({id:"navHeader.signInText",defaultMessage:"Sign In"}),MENU:s({id:"navHeader.mainMenuText",defaultMessage:"Main Menu"})}
if(["MY_ACCOUNT","SIGN_IN"].includes(i))t=a.a.createElement(Co,{fallbackText:s({id:"navHeader.accountText",defaultMessage:"Account"})})
else{var d=p[i]||p.MENU
t=a.a.createElement("span",null,d)}var h=l?lr.a:Oi.a
return a.a.createElement(r.Fragment,null,a.a.createElement(hr.a,{key:"backButton",action:u},a.a.createElement(zt.a,{src:h})),a.a.createElement("h2",{key:"title",className:f.title},t))},ji=Ti
Ti.propTypes={classes:Object(Je.shape)({title:Je.string}),isTopLevel:Je.bool,onBack:Je.func.isRequired,view:Je.string.isRequired}
var Ci=n("TBxb"),Ai=n.n(Ci),Ni={injectType:"singletonStyleTag",insert:"head",singleton:!0},Li=(at()(Ai.a,Ni),Ai.a.locals||{}),Pi=a.a.lazy(function(){return Promise.all([n.e(0),n.e(7),n.e(46)]).then(n.bind(null,"yu8+"))}),Mi=function Navigation(e){var t=function useNavigation(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},t=Object(pt.a)(_o,e.operations),n=t.getCustomerQuery,a=t.getRootCategoryId,o=Object(Ze.b)(),i=N()(o,2),s=i[0],c=i[1].closeDrawer,u=Object(vo.b)(),l=N()(u,2),f=l[0],p=l[1].actions,d=Object(bo.b)(),h=N()(d,2)[1].getUserDetails,m=Object(yo.a)(n)
Object(r.useEffect)(function(){h({fetchUserDetails:m})},[m,h])
var g=Object(S.useQuery)(a,{fetchPolicy:"cache-and-network"}).data,v=Object(r.useMemo)(function(){if(g)return g.storeConfig.root_category_id},[g]),b="nav"===s.drawer,y=f.categories,_=Object(r.useState)("MENU"),E=N()(_,2),w=E[0],O=E[1],k=Object(r.useState)(v),x=N()(k,2),I=x[0],T=x[1]
Object(r.useEffect)(function(){v&&!I&&T(v)},[I,v])
var j=y[I],C=I===v,A="MENU"!==w,L=Object(r.useCallback)(function(){var e=Eo[w]
...
return{catalogActions:p,categoryId:I,handleBack:L,handleClose:P,hasModal:A,isOpen:b,isTopLevel:C,setCategoryId:T,showCreateAccount:M,showForgotPassword:R,showMainMenu:D,showMyAccount:F,showSignIn:q,view:w}}(),n=t.catalogActions,o=t.categoryId,i=t.handleBack,s=t.handleClose,c=t.hasModal,u=t.isOpen,l=t.isTopLevel,f=t.setCategoryId,p=t.showCreateAccount,d=t.showForgotPassword,h=t.showMainMenu,m=t.showMyAccount,g=t.showSignIn,v=t.view,b=Object(pt.a)(Li,e.classes),y=u?b.root_open:b.root,_=c?b.modal_open:b.modal,E=c?b.body_masked:b.body,w=c?a.a.createElement(r.Suspense,{fallback:a.a.createElement(wi.a,null)},a.a.createElement(Pi,{closeDrawer:s,showCreateAccount:p,showForgotPassword:d,showMainMenu:h,showMyAccount:m,showSignIn:g,view:v})):null
return a.a.createElement("aside",{className:y},a.a.createElement("header",{className:b.header},a.a.createElement(ji,{isTopLevel:l,onBack:i,view:v})),a.a.createElement("div",{className:E},a.a.createElement(ni,{categoryId:o,onNavigate:s,setCategoryId:f,updateCategories:n.updateCategories})),a.a.createElement("div",{className:b.footer},a.a.createElement("div",{className:b.switchers},a.a.createElement(Ei,null),a.a.createElement(hi,null)),a.a.createElement(Do,{disabled:c,showMyAccount:m,showSignIn:g})),a.a.createElement("div",{className:_},w))},Ri=Mi
Mi.propTypes={classes:Object(Je.shape)({body:Je.string,form_closed:Je.string,form_open:Je.string,footer:Je.string,header:Je.string,root:Je.string,root_open:Je.string,signIn_closed:Je.string,signIn_open:Je.string})}
var Di,Fi=n("DUu4"),qi=function HomePage(){return null},Ui=n("TMas"),zi=(new Set).add(301).add(302),Bi=globalThis.fetchRootComponent,Wi=void 0===Bi?function warning(){return new Error("fetchRootComponent is not defined")}:Bi,Hi=Wi.default||Wi,Vi={resolveUrlQuery:Object(S.gql)(Di||(Di=he()(["\n    query ResolveURL($url: String!) {\n        urlResolver(url: $url) {\n            id\n            relative_url\n            redirectCode\n            type\n        }\n    }\n"])))},Gi=function useMagentoRoute(){var e,t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},n=Object(pt.a)(Vi,t.operations).resolveUrlQuery,a=Object(Ye.g)().replace,o=Object(Ye.h)().pathname,i=Object(Ui.b)(),s=N()(i,2),c=s[0],u=s[1],l=Object(r.useCallback)(function(e,t){u(function(n){return new Map(n).set(e,t)})},[u]),f=Object(S.useQuery)(n,{fetchPolicy:"cache-and-network",nextFetchPolicy:"cache-first",variables:{url:o}}),p=f.data,d=f.error,h=f.loading,m=(p||{}).urlResolver,g=m||{},v=g.id,b=g.redirectCode,y=g.relative_url,_=g.type,E=c.get(o),w=!m||!_||v<1,O=function isRedirect(e){return zi.has(e)}(b),k=E instanceof Error&&E,x=k||d
...
Os.propTypes={actionText:Je.string,dismissable:Je.bool,icon:Je.object,id:Je.number,message:Je.string.isRequired,onAction:Je.func,onDismiss:Je.func,handleAction:Je.func,handleDismiss:Je.func,type:Object(Je.oneOf)(["info","warning","error","success"]).isRequired}
var Ss=Os,ks=n("ONXf"),xs=n.n(ks),Is={injectType:"singletonStyleTag",insert:"head",singleton:!0},Ts=(at()(xs.a,Is),xs.a.locals||{}),js=function ToastContainer(e){var t=Object(pt.a)(Ts,e.classes),n=Object(Xe.a)(),r=N()(n,1)[0].toasts,o=Array.from(r).sort(function sortByTimestamp(e,t){var n=N()(e,2)[1],r=N()(t,2)[1]
return n.timestamp-r.timestamp}).map(function(e){var t=N()(e,2),n=t[0],r=t[1],o=r.isDuplicate?Math.random():n
return a.a.createElement(Ss,pe()({key:o},r))})
return a.a.createElement("div",{id:"toast-root",className:t.root},o)}
js.propTypes={classes:Object(Je.shape)({root:Je.string})}
var Cs=js,As=n("M7gd"),Ns=n("R7q8"),Ls=n("QMhA"),Ps=a.a.createElement(As.a,{src:Ns.a,attrs:{width:18}}),Ms=a.a.createElement(As.a,{src:mn.a,attrs:{width:18}}),Rs=a.a.createElement(As.a,{src:Ls.a,attrs:{width:18}}),Ds=function App(e){var t=e.markErrorHandled,n=e.renderError,o=e.unhandledErrors,i=Object(Ke.a)().formatMessage,s=Object(Xe.a)(),c=N()(s,2)[1].addToast,u=i({id:"app.errorUnexpected",defaultMessage:"Sorry! An unexpected error occurred."}),l=Object(r.useCallback)(function(){c({type:"error",icon:Ms,message:i({id:"app.errorOffline",defaultMessage:"You are offline. Some features may be unavailable."}),timeout:3e3})},[c,i]),f=Object(r.useCallback)(function(){c({type:"info",icon:Ps,message:i({id:"app.infoOnline",defaultMessage:"You are online."}),timeout:3e3})},[c,i]),p=function useApp(e){var t=e.handleError,n=e.handleIsOffline,a=e.handleIsOnline,o=e.markErrorHandled,i=e.renderError,s=e.unhandledErrors,c=Object(Ye.g)(),u=Object(r.useCallback)(function(){c.go(0)},[c]),l=Object(r.useMemo)(function(){return i?[Object($e.a)(i,globalThis,useApp,i.stack)]:[]},[i]),f=i?l:s,p=i?u:o
...
var d=Object(Ze.b)(),h=N()(d,2),m=h[0],g=h[1].closeDrawer,v=m.hasBeenOffline,b=m.isOnline,y=m.overlay
return Object(r.useEffect)(function(){v&&(b?a():n())},[a,n,v,b]),{hasOverlay:!!y,handleCloseDrawer:Object(r.useCallback)(function(){g()},[g])}}({handleError:Object(r.useCallback)(function(e,t,n,r){var a={icon:Rs,message:"".concat(u,"\nDebug: ").concat(t," ").concat(n),onDismiss:function onDismiss(e){r(),e()},timeout:15e3,type:"error"}
...
return n?a.a.createElement(ut.a,null,a.a.createElement(lt.b,null),a.a.createElement(co,{isMasked:!0}),a.a.createElement(go,{isActive:!0}),a.a.createElement(Cs,null)):a.a.createElement(ut.a,null,a.a.createElement(lt.b,null),a.a.createElement(co,{isMasked:d},a.a.createElement(bs,null)),a.a.createElement(go,{isActive:d,dismiss:h}),a.a.createElement(r.Suspense,{fallback:null},a.a.createElement(Ri,null)),a.a.createElement(Cs,null))}
Ds.propTypes={markErrorHandled:Je.func.isRequired,renderError:Object(Je.shape)({stack:Je.string}),unhandledErrors:Je.array},Ds.globalCSS=ct
var Fs=Ds,qs=n("lwsE"),Us=n.n(qs),zs=n("W8MJ"),Bs=n.n(zs),Ws=n("7W2i"),Hs=n.n(Ws),Vs=n("a1gu"),Gs=n.n(Vs),Ks=n("Nsbk"),Js=n.n(Ks)
function _createSuper(e){var t=function _isNativeReflectConstruct(){if("undefined"==typeof Reflect||!Reflect.construct)return!1
if(Reflect.construct.sham)return!1
if("function"==typeof Proxy)return!0
try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch(e){return!1}}()
return function _createSuperInternal(){var n,r=Js()(e)
if(t){var a=Js()(this).constructor
n=Reflect.construct(r,arguments,a)}else n=r.apply(this,arguments)
return Gs()(this,n)}}var Qs=function AppContainer(){var e=function useErrorBoundary(e){return Object(r.useMemo)(function(){return function(t){Hs()(ErrorBoundary,t)
var n=_createSuper(ErrorBoundary)
function ErrorBoundary(e){var t
return Us()(this,ErrorBoundary),(t=n.call(this,e)).state={renderError:null},t}return Bs()(ErrorBoundary,[{key:"render",value:function render(){var t=this.props,n=this.state.renderError
return a.a.createElement(e,pe()({},t,{renderError:n}))}}],[{key:"getDerivedStateFromError",value:function getDerivedStateFromError(e){return{renderError:e}}}]),ErrorBoundary}(r.Component)},[])}(Fs),t=Object(Ge.b)(),n=N()(t,2),o=n[0],i=n[1]
return a.a.createElement(e,pe()({unhandledErrors:o},i))},Xs=new Y.a,Ys=function StoreCodeRoute(){var e=Object(Ye.g)(),t=[],n={},a={};[{code:"default",id:1,secure_base_media_url:"https://qa-acemart-backend.magedelight.magentoprojects.net/pub/media/",store_name:"Acemart.com",default_display_currency_code:"USD"},{code:"s430",id:14,secure_base_media_url:"https://qa-acemart-backend.magedelight.magentoprojects.net/pub/media/",store_name:"Arlington",default_display_currency_code:"USD"},{code:"s460",id:16,secure_base_media_url:"https://qa-acemart-backend.magedelight.magentoprojects.net/pub/media/",store_name:"Downtown Dallas",default_display_currency_code:"USD"},{code:"s100",id:2,secure_base_media_url:"https://qa-acemart-backend.magedelight.magentoprojects.net/pub/media/",store_name:"Downtown San Antonio",default_display_currency_code:"USD"},{code:"s410",id:12,secure_base_media_url:"https://qa-acemart-backend.magedelight.magentoprojects.net/pub/media/",store_name:"Garland",default_display_currency_code:"USD"},{code:"s420",id:13,secure_base_media_url:"https://qa-acemart-backend.magedelight.magentoprojects.net/pub/media/",store_name:"Haltom City",default_display_currency_code:"USD"},{code:"s310",id:8,secure_base_media_url:"https://qa-acemart-backend.magedelight.magentoprojects.net/pub/media/",store_name:"Heights Houston",default_display_currency_code:"USD"},{code:"s210",id:6,secure_base_media_url:"https://qa-acemart-backend.magedelight.magentoprojects.net/pub/media/",store_name:"North Austin",default_display_currency_code:"USD"},{code:"s400",id:11,secure_base_media_url:"https://qa-acemart-backend.magedelight.magentoprojects.net/pub/media/",store_name:"North Dallas",default_display_currency_code:"USD"},{code:"s120",id:4,secure_base_media_url:"https://qa-acemart-backend.magedelight.magentoprojects.net/pub/media/",store_name:"North San Antonio",default_display_currency_code:"USD"},{code:"s440",id:15,secure_base_media_url:"https://qa-acemart-backend.magedelight.magentoprojects.net/pub/media/",store_name:"Plano",default_display_currency_code:"USD"},{code:"s200",id:5,secure_base_media_url:"https://qa-acemart-backend.magedelight.magentoprojects.net/pub/media/",store_name:"South Austin",default_display_currency_code:"USD"},{code:"s330",id:9,secure_base_media_url:"https://qa-acemart-backend.magedelight.magentoprojects.net/pub/media/",store_name:"Spring",default_display_currency_code:"USD"},{code:"s340",id:10,secure_base_media_url:"https://qa-acemart-backend.magedelight.magentoprojects.net/pub/media/",store_name:"West Houston",default_display_currency_code:"USD"},{code:"s110",id:3,secure_base_media_url:"https://qa-acemart-backend.magedelight.magentoprojects.net/pub/media/",store_name:"West San Antonio",default_display_currency_code:"USD"},{code:"s300",id:7,secure_base_media_url:"https://qa-acemart-backend.magedelight.magentoprojects.net/pub/media/",store_name:"Southeast Houston",default_display_currency_code:"USD"}].forEach(function(e){t.push(e.code),n[e.code]=e.default_display_currency_code,a[e.code]=e.secure_base_media_url}),t.sort(function(e,t){return t.length-e.length})
...
return Object(r.useEffect)(function(){c&&c!==u&&(Xs.setItem("store_view_code",c),Xs.setItem("store_view_currency",n[c]),Xs.setItem("store_view_secure_base_media_url",a[c]),e.go(0))},[u,e,c,n,a]),null},$s=function Adapter(e){var t=function useAdapter(e){var t=e.origin,n=e.store,a=e.styles,o=ae.getItem("store_view_code")||"default",i=oe?"/".concat(o):null,c=Object(r.useState)(!1),u=N()(c,2),l=u[0],f=u[1],p=Object(r.useMemo)(function(){return new URL("/graphql",t).toString()},[t]),d=Object(r.useMemo)(function(){return Object(M.a)(function(e,t){var n=t.headers,r=ae.getItem("signin_token")
...
if(!o)return null
var l=e.children||a.a.createElement(Qs,null),f=u?a.a.createElement(Ys,null):null
return a.a.createElement(S.ApolloProvider,n,a.a.createElement(k.a,i,a.a.createElement(x.a,c,f,a.a.createElement(Ve,null,l))))},Zs=n("kZ59"),ec=!globalThis.document,tc=ec?"https://qa-acemart-backend.magedelight.magentoprojects.net":globalThis.location.origin,nc=new Set,rc=a.a.createElement($s,{origin:tc,store:w,styles:nc})
ec?n.e(0).then(n.t.bind(null,"KAy6",7)).then(function(e){e.default}):(Object(o.render)(rc,document.getElementById("root")),function registerSW(){Zs.b&&globalThis.navigator&&(window.navigator.serviceWorker.register("/sw.js").then(function(){}).catch(function(){window.console.warn("Failed to register SW.")}),navigator.serviceWorker.addEventListener("message",function(e){var t=e.data,n=t.type,r=t.payload
Object(Zs.c)(n,r,e)}))}(),globalThis.addEventListener("online",function(){w.dispatch(O.a.setOnline())}),globalThis.addEventListener("offline",function(){w.dispatch(O.a.setOffline())}))},tngr:function(e,t,n){"use strict"
var r=n("FH7K")
