...
a.forEach(function(n){c.extend(n)}),i.fitBounds(c)}1===a.length&&(i.setCenter(a[0]),i.setZoom(j.b.mapOptions.zoom))}).catch(function(n){}),function(){n&&e.forEach(function(t){n.clearInstanceListeners(t)})}}},[o,s,l]),s.length?a.a.createElement("div",{ref:t,style:E,className:[e.root].concat(r()(S)).join(" ")}):null}
...
o.forEach(function(t){n[t]&&s.push(`${t}=${n[t]}`)}),n.libraries&&n.libraries.length&&s.push(`libraries=${n.libraries.join(",")}`),a.src=`${n.apiUrl||"https://maps.googleapis.com/maps/api/js"}?${s.join("&")}`,document.body.appendChild(a)})}},rtJZ:function(n,t,e){(t=n.exports=e("JPst")(!1)).push([n.i,".map-root-2k8 {\n    height: 300px;\n}\n.map-root-2k8 .gm-style .gm-style-iw-c {\n    padding: 18px;\n}\n.map-root-2k8 .map-popup {\n    min-width: 200px;\n}\n.map-root-2k8 .map-popup h3 {\n    margin: 0 0 18px 0;\n    font-weight: 300;\n}\n.map-root-2k8 .map-popup p {\n    font-size: 16px;\n}\n.map-root-2k8 .map-popup p.map-comment {\n    font-size: 14px;\n}\n.map-root-2k8 .gm-style img {\n    max-width: none;\n    max-height: none;\n    margin: 0;\n}\n",""]),t.locals={root:"map-root-2k8"}}}])
