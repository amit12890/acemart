...
return{s:u,n:function n(){return o>=t.length?{done:!0}:{done:!1,value:t[o++]}},e:function e(t){throw t},f:u}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var a,h=!0,c=!1
return{s:function s(){i=i.call(t)},n:function n(){var t=i.next()
return h=t.done,t},e:function e(t){c=!0,a=t},f:function f(){try{h||null==i.return||i.return()}finally{if(c)throw a}}}}function _arrayLikeToArray(t,r){(null==r||r>t.length)&&(r=t.length)
...
t.exports=Array.isArray||function(t){return"[object Array]"==e.call(t)}},H7XF:function(t,r,e){"use strict"
r.byteLength=function byteLength(t){var r=getLens(t),e=r[0],n=r[1]
return 3*(e+n)/4-n},r.toByteArray=function toByteArray(t){var r,e,n=getLens(t),o=n[0],u=n[1],a=new i(function _byteLength(t,r,e){return 3*(r+e)/4-e}(0,o,u)),s=0,h=u>0?o-4:o
for(e=0;e<h;e+=4)r=f[t.charCodeAt(e)]<<18|f[t.charCodeAt(e+1)]<<12|f[t.charCodeAt(e+2)]<<6|f[t.charCodeAt(e+3)],a[s++]=r>>16&255,a[s++]=r>>8&255,a[s++]=255&r
...
return e.variants.map(function(t){return t.attributes.map(function(t){return t.uid}).sort().toString()===n&&t.product}).filter(Boolean)[0]}}e.d(r,"a",function(){return configuredVariant})}).call(this,e("tjlA").Buffer)},"kVK+":function(t,r){r.read=function(t,r,e,n,f){var i,o,u=8*f-n-1,a=(1<<u)-1,s=a>>1,h=-7,c=e?f-1:0,l=e?-1:1,p=t[r+c]
for(c+=l,i=p&(1<<-h)-1,p>>=-h,h+=u;h>0;i=256*i+t[r+c],c+=l,h-=8);for(o=i&(1<<-h)-1,i>>=-h,h+=n;h>0;o=256*o+t[r+c],c+=l,h-=8);if(0===i)i=1-s
else{if(i===a)return o?NaN:1/0*(p?-1:1)
o+=Math.pow(2,n),i-=s}return(p?-1:1)*o*Math.pow(2,i-n)},r.write=function(t,r,e,n,f,i){var o,u,a,s=8*i-f-1,h=(1<<s)-1,c=h>>1,l=23===f?Math.pow(2,-24)-Math.pow(2,-77):0,p=n?0:i-1,g=n?1:-1,y=r<0||0===r&&1/r<0?1:0
for(r=Math.abs(r),isNaN(r)||r===1/0?(u=isNaN(r)?1:0,o=h):(o=Math.floor(Math.log(r)/Math.LN2),r*(a=Math.pow(2,-o))<1&&(o--,a*=2),(r+=o+c>=1?l/a:l*Math.pow(2,1-c))*a>=2&&(o++,a/=2),o+c>=h?(u=0,o=h):o+c>=1?(u=(r*a-1)*Math.pow(2,f),o+=c):(u=r*Math.pow(2,c-1)*Math.pow(2,f),o=0));f>=8;t[e+p]=255&u,p+=g,u/=256,f-=8);for(o=o<<f|u,s+=f;s>0;t[e+p]=255&o,p+=g,o/=256,s-=8);t[e+p-g]|=128*y}},tjlA:function(t,r,e){"use strict";(function(t){var n=e("H7XF"),f=e("kVK+"),i=e("49sm")
...
for(i=e;i<u;i++)if(read(t,i)===read(r,-1===s?0:i-s)){if(-1===s&&(s=i),i-s+1===a)return s*o}else-1!==s&&(i-=i-s),s=-1}else for(e+a>u&&(e=u-a),i=e;i>=0;i--){for(var h=!0,c=0;c<a;c++)if(read(t,i+c)!==read(r,c)){h=!1
break}if(h)return i}return-1}function hexWrite(t,r,e,n){e=Number(e)||0
var f=t.length-e
...
for(var n=[],f=r;f<e;){var i,u,a,s,h=t[f],c=null,l=h>239?4:h>223?3:h>191?2:1
if(f+l<=e)switch(l){case 1:h<128&&(c=h)
break
...
break
case 4:i=t[f+1],u=t[f+2],a=t[f+3],128==(192&i)&&128==(192&u)&&128==(192&a)&&(s=(15&h)<<18|(63&i)<<12|(63&u)<<6|63&a)>65535&&s<1114112&&(c=s)}null===c?(c=65533,l=1):c>65535&&(c-=65536,n.push(c>>>10&1023|55296),c=56320|1023&c),n.push(c),f+=l}return function decodeCodePointsArray(t){var r=t.length
...
if(r>=e)return 1
if(this===t)return 0
for(var i=(f>>>=0)-(n>>>=0),o=(e>>>=0)-(r>>>=0),u=Math.min(i,o),a=this.slice(n,f),s=t.slice(r,e),h=0;h<u;++h)if(a[h]!==s[h]){i=a[h],o=s[h]
