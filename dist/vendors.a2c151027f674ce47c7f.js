...
=======
 * @version f78ba83-dev
>>>>>>> origin/development:dist/vendors.a2c151027f674ce47c7f.js
 * 
 */
...
return[r.context,e,t]},[r]),l=a[0],s=a[1],f=a[2],p=Object(n.useMemo)(function(){return l&&l.Consumer&&Object(g.isContextConsumer)(o.a.createElement(l.Consumer,null))?l:I},[l,I]),v=Object(n.useContext)(p),y=Boolean(r.store)&&Boolean(r.store.getState)&&Boolean(r.store.dispatch),S=Boolean(v)&&Boolean(v.store)
...
return[e,t]},[j,y,v]),C=E[0],P=E[1],_=Object(n.useMemo)(function(){return y?v:_extends({},v,{subscription:C})},[y,v,C]),F=Object(n.useReducer)(storeStateUpdatesReducer,O,k),R=F[0][0],T=F[1]
if(R&&R.error)throw R.error
var A=Object(n.useRef)(),L=Object(n.useRef)(f),M=Object(n.useRef)(),D=Object(n.useRef)(!1),N=c(function(){return M.current&&f===L.current?M.current:x(j.getState(),f)},[j,R,f])
m(function(){L.current=f,A.current=N,D.current=!1,M.current&&(M.current=null,P())}),m(function(){if(h){var e=!1,t=null,r=function checkForUpdates(){if(!e){var r,n,o=j.getState()
...
var ce=_slicedToArray(useStateWithGetter(I(ie,l,d,p)),3),fe=ce[0],de=ce[1],pe=ce[2],he=_slicedToArray(useStateWithGetter(m?ue(fe):void 0),3),ve=he[0],ye=he[1],be=he[2],ge=_slicedToArray(useStateWithGetter(ae),3),me=ge[0],Oe=ge[1],we=ge[2],ke=_slicedToArray(useStateWithGetter(0),3),Se=(ke[0],ke[1]),je=ke[2],xe=_slicedToArray(useStateWithGetter(0),3),Ee=(xe[0],xe[1]),Ce=xe[2],Pe=_slicedToArray(Object(n.useState)(function(){return R(fe,c,f,d)}),2),_e=Pe[0],Fe=Pe[1],Ie=Object(n.useRef)(h),Re=Object(n.useRef)(r),Te=Object(n.useRef)()
...
Ee(h.offset),t=a=h.value}p&&(t=null!=t?p(t):t),ue&&b&&!o.initial&&(F("Validating after change ".concat(r," ").concat(t)),Qe(ue(t,te.getValues()))),de(t),Fe(a),S&&S(t),Y.setValue(X,t,!o.preventUpdate)},We=function setTouched(e,t){var n=(arguments.length>2&&void 0!==arguments[2]?arguments[2]:{}).preventUpdate
...
Ee(i.offset),de(i.value),Fe(i.value),S&&S(i.value),Y.setValue(X,i.value,!n)}Oe(e),Y.setTouched(X,e,!n)},Be={setValue:qe,setTouched:We,setError:Qe,reset:function reset(){var e=(arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}).preventUpdate,t=I(Ie.current||Y.getInitialValue(Re.current),l,d,p)
...
return o.a.createElement("input",_extends({},v,{name:p,ref:h,value:c,checked:i===c,onChange:function onChange(e){e.target.checked&&(a(c),f&&f(e),l&&l(e))},onBlur:function onBlur(e){u(!0),d&&d(e),s&&s(e)},type:"radio"}))}),G=z(function(e){_inherits(RadioGroup,n["Component"])
...
var K=a("informed:useArrayField\t"),$=function useArrayField(e){var t=e.field,r=e.initialValue,i=e.validate,a=e.arrayFieldApiRef,u=_objectWithoutProperties(e,["field","initialValue","validate","arrayFieldApiRef"]),l=useFormApi(),s=_slicedToArray(Object(n.useState)(new Map),1)[0],c=Object(n.useContext)(y),f=l.getFullField(t),d=c.getInitialValue(t)||r||[],p=_slicedToArray(useStateWithGetter(l.getSavedValue(f)&&l.getSavedValue(f).value||d),3),h=p[0],b=p[1],g=p[2],m=_slicedToArray(useStateWithGetter(h?h.map(function(){return E()}):[]),3),k=m[0],S=m[1],j=m[2],x=Object(n.useMemo)(function(){return function(e,t){var r=null==j()?0:j().length
return i?i(e,r,t):void 0}}),C=useField(_objectSpread2({field:t,validate:i?x:void 0,shadow:!0},u)).fieldApi
_(function(){var e=function onChangeHandler(e){e!==f&&(K("".concat(f," changed")),RegExp("".concat(f,"\\[[0-9]+\\]")).test(e)&&C.validate())}
return l.emitter.on("value",e),function(){l.emitter.removeListener("value",e)}},[t])
var P=function swap(e,r){K("Swapping","".concat(t,"[").concat(e,"] and ").concat(t,"[").concat(r,"]"))
...
t[k.length-1]=e,b(t)},R=k.map(function(e,r){var n={remove:function remove(){return function remove(e){K("EXPECTING REMOVAL OF","".concat(t,"[").concat(e,"] and ").concat(t,"[").concat(k.length-1,"]")),c.expectRemoval("".concat(t,"[").concat(e,"]")),c.expectRemoval("".concat(t,"[").concat(k.length-1,"]"))
