...
return r.variants.map(function(t){return t.attributes.map(function(t){return t.uid}).sort().toString()===n&&t.product}).filter(Boolean)[0]}}r.d(e,"a",function(){return configuredVariant})}).call(this,r("tjlA").Buffer)},"kVK+":function(t,e){e.read=function(t,e,r,n,i){var o,f,u=8*i-n-1,a=(1<<u)-1,s=a>>1,c=-7,h=r?i-1:0,l=r?-1:1,p=t[e+h]
...
f+=Math.pow(2,n),o-=s}return(p?-1:1)*f*Math.pow(2,o-n)},e.write=function(t,e,r,n,i,o){var f,u,a,s=8*o-i-1,c=(1<<s)-1,h=c>>1,l=23===i?Math.pow(2,-24)-Math.pow(2,-77):0,p=n?0:o-1,g=n?1:-1,y=e<0||0===e&&1/e<0?1:0
