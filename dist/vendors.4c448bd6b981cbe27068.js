...
r.d(t,"a",function(){return p}),r.d(t,"b",function(){return P}),r.d(t,"c",function(){return F}),r.d(t,"d",function(){return R})
...
var I=_
return function wrapWithConnect(t){var r=t.displayName||t.name||"Component",i=a(r),u=_extends({},F,{getDisplayName:a,methodName:s,renderCountProp:f,shouldHandleStateChanges:h,storeKey:j,displayName:i,wrappedComponentName:r,WrappedComponent:t}),l=F.pure
...
return[r.context,e,t]},[r]),l=a[0],s=a[1],f=a[2],p=Object(n.useMemo)(function(){return l&&l.Consumer&&Object(g.isContextConsumer)(o.a.createElement(l.Consumer,null))?l:I},[l,I]),v=Object(n.useContext)(p),y=Boolean(r.store)&&Boolean(r.store.getState)&&Boolean(r.store.dispatch),j=Boolean(v)&&Boolean(v.store)
...
return[e,t]},[S,y,v]),C=E[0],P=E[1],_=Object(n.useMemo)(function(){return y?v:_extends({},v,{subscription:C})},[y,v,C]),F=Object(n.useReducer)(storeStateUpdatesReducer,O,k),R=F[0][0],T=F[1]
if(R&&R.error)throw R.error
var L=Object(n.useRef)(),A=Object(n.useRef)(f),M=Object(n.useRef)(),D=Object(n.useRef)(!1),N=c(function(){return M.current&&f===A.current?M.current:x(S.getState(),f)},[S,R,f])
m(function(){A.current=f,L.current=N,D.current=!1,M.current&&(M.current=null,P())}),m(function(){if(h){var e=!1,t=null,r=function checkForUpdates(){if(!e){var r,n,o=S.getState()
try{r=x(o,A.current)}catch(e){n=e,t=e}n||(t=null),r===L.current?D.current||P():(L.current=r,M.current=r,D.current=!0,T({type:"STORE_UPDATED",payload:{error:n}}))}}
...
return y.displayName=i,y.WrappedComponent=t,v()(y,t)}return v()(p,t)}}var j=Object.prototype.hasOwnProperty
...
var a=o,l=a.pure,c=void 0===l||l,d=a.areStatesEqual,p=void 0===d?strictEqual:d,h=a.areOwnPropsEqual,v=void 0===h?shallowEqual:h,y=a.areStatePropsEqual,b=void 0===y?shallowEqual:y,g=a.areMergedPropsEqual,m=void 0===g?shallowEqual:g,O=_objectWithoutPropertiesLoose(a,["pure","areStatesEqual","areOwnPropsEqual","areStatePropsEqual","areMergedPropsEqual"]),w=match(e,i,"mapStateToProps"),k=match(t,u,"mapDispatchToProps"),j=match(r,s,"mergeProps")
return n(f,_extends({methodName:"connect",getDisplayName:function getDisplayName(e){return"Connect("+e+")"},shouldHandleStateChanges:Boolean(e),initMapStateToProps:w,initMapDispatchToProps:k,initMergeProps:j,pure:c,areStatesEqual:p,areOwnPropsEqual:v,areStatePropsEqual:b,areMergedPropsEqual:m},O))}}()
...
return function useStore(){return t().store}}var _=createStoreHook()
var F=function createDispatchHook(e){void 0===e&&(e=u)
var t=e===u?_:createStoreHook(e)
return function useDispatch(){return t().dispatch}}(),I=function refEquality(e,t){return e===t}
var R=function createSelectorHook(e){void 0===e&&(e=u)
var t=e===u?useReduxContext_useReduxContext:function(){return Object(n.useContext)(e)}
return function useSelector(e,r){void 0===r&&(r=I),b()(e,"You must pass a selector to useSelectors")
var o=t()
...
return t.filter(function(e){return e}).join(" ")}(d,l):d,_=C?_extends({},O,{},f):O,F=_extends({"aria-current":C&&o||null,className:P,style:_,to:a},j)
return v!==y?F.ref=t||k:F.innerRef=k,i.a.createElement(h,F)})})},"6CgR":function(e,t,r){"use strict"
...
return isFieldValueToBeMerged(n)?(n.__value=this.merge(n.__value,isFieldValueToBeMerged(o)?o.__value:o),n):isFieldValueToBeMerged(o)?(o.__value=this.merge(n,o.__value),o):this.merge(n,o)}},"8UhI":function(e,t,r){"use strict";(function(e){r.d(t,"a",function(){return G}),r.d(t,"b",function(){return U}),r.d(t,"c",function(){return ve}),r.d(t,"d",function(){return ge}),r.d(t,"e",function(){return H}),r.d(t,"f",function(){return K}),r.d(t,"g",function(){return Y}),r.d(t,"h",function(){return B}),r.d(t,"i",function(){return Q}),r.d(t,"j",function(){return q}),r.d(t,"k",function(){return z}),r.d(t,"l",function(){return useFieldApi}),r.d(t,"m",function(){return useFieldState}),r.d(t,"n",function(){return useFormApi}),r.d(t,"o",function(){return useFormState})
...
return _objectSpread2({value:e.const,label:e.title},r)})
O.props.options=j}return O},P=function informedFormat(e,t){if(!e)return{value:e,offset:0}
...
i.push(f)}}return{value:i.join(""),offset:e?i.length-e.length:0}},_="undefined"!=typeof window&&void 0!==window.document&&void 0!==window.document.createElement?n.useLayoutEffect:n.useEffect,F=a("informed:useField\t"),I=function initializeValue(e,t,r,n){if(null!=e)return t?t(e):r&&!n?P(e,r).value:e},R=function initializeMask(e,t,r,n){return t&&r?t(e):n?P(e,n).value:e},T=function generateValidationFunction(e,t,r){var n=r.required
...
return e.inner[0].message}}(e)}}(t,r):e?e(r,n):void 0}:n?function(e){return N(e,n)}:void 0},L=function generateOnChange(e){var t=e.fieldType,r=e.setValue,n=e.onChange,o=e.multiple,i=e.ref,a=function setter(e){return r(e)}
...
var ce=_slicedToArray(useStateWithGetter(I(ie,l,d,p)),3),fe=ce[0],de=ce[1],pe=ce[2],he=_slicedToArray(useStateWithGetter(m?ue(fe):void 0),3),ve=he[0],ye=he[1],be=he[2],ge=_slicedToArray(useStateWithGetter(ae),3),me=ge[0],Oe=ge[1],we=ge[2],ke=_slicedToArray(useStateWithGetter(0),3),je=(ke[0],ke[1]),Se=ke[2],xe=_slicedToArray(useStateWithGetter(0),3),Ee=(xe[0],xe[1]),Ce=xe[2],Pe=_slicedToArray(Object(n.useState)(function(){return R(fe,c,f,d)}),2),_e=Pe[0],Fe=Pe[1],Ie=Object(n.useRef)(h),Re=Object(n.useRef)(r),Te=Object(n.useRef)()
Ie.current=h,Re.current=r
var Le=function relevantFunc(){return!0},Ae=function relevant(e){var t=G||Le,r=te.getFullField(Re.current)||Re.current,n={path:r,parentPath:r.replace(/(.*)[.[].*/,"$1"),get:function get(e,t){return v.get(e,t)}}
return Z&&Z.relevant?t(e,n)&&Z.relevant(e,n):t(e,n)},Me=_slicedToArray(useStateWithGetter(Ae(te.getValues())),3),De=Me[0],Ne=Me[1],ze=Me[2]
...
Q&&te.getStep()<Q?(F("Setting ".concat(r,"'s error to undefined as we are not at that step")),ye(void 0),Y.setError(X,void 0,!t)):(F("Setting ".concat(r,"'s error to ").concat(e)),ye(e),Y.setError(X,e,!t))},qe=function setValue(t,n){var o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{}
F("Setting ".concat(r," to ").concat(t))
var i=te.getOptions(),a=t
if(""!==t||k||o.allowEmptyString||i.allowEmptyStrings||(t=void 0),"number"!==e.type&&"number"!==q||void 0===t||(t=+t),n&&n.target&&n.target.selectionStart&&je(n.target.selectionStart),l&&!w&&(a=l(t,Se()),t=l(t,Se())),s&&!w){var u=s(t,Se())
a=u.value,t=u.value,Ee(u.offset)}if(c&&f&&(t=f(t),a=c(t)),d){var h=P(t,d)
Ee(h.offset),t=a=h.value}p&&(t=null!=t?p(t):t),ue&&b&&!o.initial&&(F("Validating after change ".concat(r," ").concat(t)),Qe(ue(t,te.getValues()))),de(t),Fe(a),j&&j(t),Y.setValue(X,t,!o.preventUpdate)},We=function setTouched(e,t){var n=(arguments.length>2&&void 0!==arguments[2]?arguments[2]:{}).preventUpdate
...
de(o),Fe(o),j&&j(o),Y.setValue(X,o,!n)}if(s&&w){var i=s(Ve())
Ee(i.offset),de(i.value),Fe(i.value),j&&j(i.value),Y.setValue(X,i.value,!n)}Oe(e),Y.setTouched(X,e,!n)},Be={setValue:qe,setTouched:We,setError:Qe,reset:function reset(){var e=(arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}).preventUpdate,t=I(Ie.current||Y.getInitialValue(Re.current),l,d,p)
qe(t,null,{initial:!0,preventUpdate:e}),Qe(m?ue(t):void 0,{preventUpdate:e}),We(void 0,!0,{preventUpdate:e})},validate:function fieldValidate(e){ue&&(F("Field validating ".concat(r," ").concat(Ve())),Qe(ue(Ve(),e||te.getValues())))},asyncValidate:function fieldAsyncValidate(e){a&&(F("Field async validating ".concat(r," ").concat(Ve())),a(Ve(),e||te.getValues()))},getValue:Ve,getTouched:we,getError:be,getIsRelevant:ze,getFieldState:function getFieldState(){return{value:Ve(),touched:we()}},relevant:Ae,multistepRelevant:function multistepRelevant(e){return!Z||!Z.relevant||Z.relevant(e)},checkRelevant:function checkRelevant(){var e=Ae(te.getValues())
return e!=ze()&&Ne(e),e}}
re.current=Be
...
_(function(){var e=te.getFullField(Re.current)
return F("Register",X,Re.current),oe.current={field:e,fieldId:X,fieldApi:Be,fieldState:Ue,notify:x,keepState:C,inMultistep:ee,shadow:V},Y.register(X,oe.current),function(){var e=te.getFullField(Re.current)
F("Deregister",X,e),Y.deregister(X)}},[]),Object(n.useEffect)(function(){var e=te.getFullField(r)
return ne.current?ne.current=!1:(F("Update",r,ee),oe.current.field=e,Y.update(X,oe.current,Te.current)),function(){Te.current=e}},[r]),_(function(){N&&null!=Ge.current&&Se()&&(Ge.current.selectionEnd=Se()+Ce())},[fe]),_(function(){z&&Ge&&(Ge.current.style.border="5px solid orange",setTimeout(function(){Ge.current.style.borderWidth="2px",Ge.current.style.borderStyle="inset",Ge.current.style.borderColor="initial",Ge.current.style.borderImage="initial"},500))})
var Ke=[].concat(_toConsumableArray(Object.values(Ue)),_toConsumableArray(Object.values(e)),_toConsumableArray(Object.values(J))),$e=r,Je=L({fieldType:q,setValue:qe,onChange:B,multiple:W,ref:Ge}),Xe=A({setTouched:We,onBlur:U}),Ye=M({fieldType:q,maskedValue:_e,multiple:W,value:fe}),Ze=D(q)
return{fieldState:Ue,fieldApi:Be,render:function render(e){return Object(n.useMemo)(function(){return De?e:null},_toConsumableArray(Ke))},ref:Ge,userProps:_objectSpread2(_objectSpread2({},J),{},{multiple:W,onChange:B,onBlur:U,id:J.id||X}),informed:_objectSpread2({name:$e,multiple:W,onChange:Je,onBlur:Xe,value:Ye,ref:Ge,type:Ze,id:J.id||X},J)}}var z=function asField(e){var t=o.a.forwardRef(function(t,r){var n=useField(t,r),i=n.fieldState,a=n.fieldApi,u=n.render,l=n.ref,s=n.userProps
return u(o.a.createElement(e,_extends({fieldApi:a,fieldState:i,field:t.field,forwardedRef:l,debug:t.debug,type:t.type},s)))})
return t.displayName="asField(".concat(function getChildDisplayName(e){return e.type&&e.type.name?e.type.name:e.displayName||e.name||"Component"}(e),")"),t},V=a("informed:Text\t"),Q=z(function Text(e){var t=e.fieldApi,r=e.fieldState,n=_objectWithoutProperties(e,["fieldApi","fieldState"]),i=r.maskedValue,a=t.setValue,u=t.setTouched,l=n.onChange,s=n.onBlur,c=n.field,f=(n.initialValue,n.forwardedRef),d=n.debug,p=n.label,h=(n.title,n.id),v=_objectWithoutProperties(n,["onChange","onBlur","field","initialValue","forwardedRef","debug","label","title","id"])
return V("Render",c),_(function(){d&&f&&(f.current.style.background="red",setTimeout(function(){f.current.style.background="white"},500))}),o.a.createElement(o.a.Fragment,null,p?o.a.createElement("label",{htmlFor:h}," ",p," "):null,o.a.createElement("input",_extends({},v,{id:h,name:c,ref:f,value:i||0===i?i:"",onChange:function onChange(e){a(e.target.value,e),l&&l(e)},onBlur:function onBlur(e){u(!0),s&&s(e)}})))}),q=z(function TextArea(e){var t=e.fieldApi,r=e.fieldState,n=_objectWithoutProperties(e,["fieldApi","fieldState"]),i=r.maskedValue,a=t.setValue,u=t.setTouched,l=n.onChange,s=n.onBlur,c=n.field,f=(n.initialValue,n.forwardedRef),d=n.debug,p=n.label,h=n.id,v=_objectWithoutProperties(n,["onChange","onBlur","field","initialValue","forwardedRef","debug","label","id"])
return _(function(){d&&f&&(f.current.style.background="red",setTimeout(function(){f.current.style.background="white"},500))}),o.a.createElement(o.a.Fragment,null,p?o.a.createElement("label",{htmlFor:h}," ",p," "):null,o.a.createElement("textarea",_extends({},v,{id:h,name:c,ref:f,value:i||"",onChange:function onChange(e){a(e.target.value,e),l&&l(e)},onBlur:function onBlur(e){u(!0),s&&s(e)}})))}),W=a("informed:Select\t"),B=z(function Select(e){var t=e.fieldApi,r=e.fieldState,i=_objectWithoutProperties(e,["fieldApi","fieldState"]),a=r.value,u=t.setTouched,l=i.onChange,s=i.onBlur,c=i.field,f=(i.initialValue,i.options),d=i.children,p=i.forwardedRef,h=i.debug,v=i.multiple,y=i.label,b=i.id,g=_objectWithoutProperties(i,["onChange","onBlur","field","initialValue","options","children","forwardedRef","debug","multiple","label","id"]),m=Object(n.useRef)()
...
return o.a.createElement("input",_extends({},v,{name:p,ref:h,value:c,checked:i===c,onChange:function onChange(e){e.target.checked&&(a(c),f&&f(e),l&&l(e))},onBlur:function onBlur(e){u(!0),d&&d(e),s&&s(e)},type:"radio"}))}),G=function(e){_inherits(RadioGroup,n["Component"])
var t=_createSuper(RadioGroup)
function RadioGroup(){return _classCallCheck(this,RadioGroup),t.apply(this,arguments)}return _createClass(RadioGroup,[{key:"render",value:function render(){var e=this.props,t=e.options,r=e.children
return o.a.createElement(m.Provider,{value:this.groupContext},t?t.map(function(e){return o.a.createElement("label",{key:e.value},e.label," ",o.a.createElement(H,{value:e.value}))}):r)}},{key:"groupContext",get:function get(){return{radioGroupApi:_objectSpread2(_objectSpread2({},this.props.fieldApi),{},{onChange:this.props.onChange,onBlur:this.props.onBlur}),radioGroupState:this.props.fieldState}}}]),RadioGroup}(),K=z(G)
var $=a("informed:useArrayField\t"),J=function useArrayField(e){var t=e.field,r=e.initialValue,i=e.validate,a=e.arrayFieldApiRef,u=_objectWithoutProperties(e,["field","initialValue","validate","arrayFieldApiRef"]),l=useFormApi(),s=_slicedToArray(Object(n.useState)(new Map),1)[0],c=Object(n.useContext)(y),f=l.getFullField(t),d=c.getInitialValue(t)||r||[],p=_slicedToArray(useStateWithGetter(l.getSavedValue(f)&&l.getSavedValue(f).value||d),3),h=p[0],b=p[1],g=p[2],m=_slicedToArray(useStateWithGetter(h?h.map(function(){return E()}):[]),3),k=m[0],j=m[1],S=m[2],x=Object(n.useMemo)(function(){return function(e,t){var r=null==S()?0:S().length
return i?i(e,r,t):void 0}}),C=useField(_objectSpread2({field:t,validate:i?x:void 0,shadow:!0},u)).fieldApi
_(function(){var e=function onChangeHandler(e){e!==f&&($("".concat(f," changed")),RegExp("".concat(f,"\\[[0-9]+\\]")).test(e)&&C.validate())}
...
k[e]&&k[r]&&(n[e]=k[r],n[r]=k[e]),j(n)},F=function add(){k.push(E()),j(_toConsumableArray(k))},I=function addWithInitialValue(e){k.push(E()),j(_toConsumableArray(k))
var t=_toConsumableArray(g())
t[k.length-1]=e,b(t)},R=k.map(function(e,r){var n={remove:function remove(){return function remove(e){$("EXPECTING REMOVAL OF","".concat(t,"[").concat(e,"] and ").concat(t,"[").concat(k.length-1,"]")),c.expectRemoval("".concat(t,"[").concat(e,"]")),c.expectRemoval("".concat(t,"[").concat(k.length-1,"]"))
...
return _objectSpread2(_objectSpread2({arrayFieldItemApi:n,arrayFieldItemState:o},n),o)}),T={add:F,swap:P,addWithInitialValue:I,reset:function reset(){var e=c.getInitialValue(t)||r||[]
b(e)
var n=e?e.map(function(){return E()}):[]
j(n)}}
a&&(a.current=T)
var L={fields:R,field:t},A=_objectSpread2(_objectSpread2({},c),{},{register:function register(e,t){s.set(e,t)
...
return o("function"==typeof t?t(_objectSpread2(_objectSpread2({field:u,arrayFieldApi:a,arrayFieldState:i},a),i)):t)},te=function ArrayFieldItem(e){var t=e.arrayFieldItemState,r=e.arrayFieldItemApi,i=e.children,a=Object(n.useContext)(y),u=useFormApi(),l=_slicedToArray(Object(n.useState)(0),2),s=(l[0],l[1]),c=_slicedToArray(Object(n.useState)(new Map),1)[0],f=t.field,d=function useScopedApi(e){var t=useFormApi()
...
var re=function FormComponents(e){var t=e.components,r=Object(n.useContext)(y).fieldMap
return t?t.map(function(e,t){var n=e["ui:control"],i=r[n]
return o.a.createElement(i,{key:"ui-comp-".concat(t)})}):null},ne=a("informed:FormFields\t"),oe=function FormFields(e){var t=e.schema,r=e.prefix,i=e.onlyValidateSchema,a=Object(n.useContext)(y).fieldMap
...
return t[e]===r.const})}},o.a.createElement(FormFields,{schema:r}))}):p?o.a.createElement(p,_extends({key:"ScheamField-".concat(t),field:r},n)):null})},[t,r])},ie=function ArrayField$1(e){var t=e.field,r=e.items,n=e.uiBefore,i=e.uiAfter,a=_objectWithoutProperties(e,["field","items","uiBefore","uiAfter"])
...
return o.a.createElement(o.a.Fragment,null,o.a.createElement(re,{components:r["ui:before"]}),o.a.createElement(oe,{schema:r,prefix:t}),o.a.createElement(re,{components:r["ui:after"]}))}),o.a.createElement(re,{components:i}))},ae={select:B,input:Q,textarea:q,checkbox:U,radio:K,add:function AddButton(){var e=function useArrayFieldApi(){return Object(n.useContext)(w)}().add
...
return t&&t.shadow?v.delete(this.savedValues,"shadow-".concat(e)):v.delete(this.savedValues,e)}},{key:"getFullField",value:function getFullField(e){return e}},{key:"getInitialValue",value:function getInitialValue(e){return v.get(this.options.initialValues,e)}},{key:"getField",value:function getField(e){ue("Getting Field",e)
...
return v.empty(e)&&v.empty(t)}},{key:"dirty",value:function dirty(){return!this.pristine()}},{key:"reset",value:function reset(){ue("Resetting"),this.fieldsById.forEach(function(e){e.fieldApi.reset({preventUpdate:!0})}),this.emit("reset"),this.emit("change")}},{key:"setValues",value:function setValues(e){ue("Setting values"),this.fieldsById.forEach(function(t){var r=v.get(e,t.field)
...
!t.keepState&&!t.inMultistep||n||(ue("Saving field ".concat(r,"'s value"),t.fieldApi.getFieldState()),t.shadow?v.set(this.savedValues,"shadow-".concat(r),t.fieldApi.getFieldState()):v.set(this.savedValues,r,t.fieldApi.getFieldState())),(n||!t.keepState&&!t.inMultistep||!t.fieldApi.getIsRelevant()&&!t.keepState)&&(ue("Removing field",r),this.fieldsById.delete(e),n||(v.delete(this.state.values,r),v.delete(this.state.touched,r),v.delete(this.state.errors,r),t.shadow?v.delete(this.savedValues,"shadow-".concat(r)):v.delete(this.savedValues,r)),n&&this.pulledOut[o]&&(ue("Pulling out",r,"with magic value",o),v.pullOut(this.state.values,o),v.pullOut(this.state.touched,o),v.pullOut(this.state.errors,o),v.pullOut(this.savedValues,o),delete this.pulledOut[o])),this.emit("change")}},{key:"expectRemoval",value:function expectRemoval(e){ue("Expecting removal of",e),this.expectedRemovals[e]=!0,this.pulledOut[e]=!0}},{key:"update",value:function update(e,t,r){ue("Update",e,t.field,r,t.fieldState.value)
var n=t.fieldApi.getValue(),o=t.fieldApi.getError(),i=t.fieldApi.getTouched(),a=this.fieldsByName.get(r)
r&&!a&&(v.set(this.state.values,r),v.set(this.state.errors,r),v.set(this.state.touched,r)),v.set(this.state.values,t.field,n),v.set(this.state.errors,t.field,o),v.set(this.state.touched,t.field,i),this.emit("change")}}]),FormController}(),ce=a("informed:FormProvider\t\t"),fe=function FormProvider(e){var t=e.children,r=e.formApi,n=e.formController,i=e.formState,a=_objectWithoutProperties(e,["children","formApi","formController","formState"])
if(ce("Render FormProvider"),r)return ce("Render FormProvider with given values"),o.a.createElement(y.Provider,{value:n.updater},o.a.createElement(g.Provider,{value:r},o.a.createElement(b.Provider,{value:i},t)))
ce("Render FormProvider with generated values")
var u=pe(a)
return o.a.createElement(y.Provider,{value:u.formController.updater},o.a.createElement(g.Provider,{value:u.formApi},o.a.createElement(b.Provider,{value:u.formState},t)))},de=a("informed:useForm\t\t"),pe=function useForm(e){var t=e.dontPreventDefault,r=e.initialValues,i=e.validate,a=e.validateFields,u=e.allowEmptyStrings,l=e.preventEnter,s=e.getApi,c=e.apiRef,f=e.onChange,d=e.onReset,p=e.onSubmit,h=e.onValueChange,v=e.onSubmitFailure,y=e.validationSchema,b=e.schema,g=e.ajv,m=e.fieldMap,O=e.onlyValidateSchema,w=_objectWithoutProperties(e,["dontPreventDefault","initialValues","validate","validateFields","allowEmptyStrings","preventEnter","getApi","apiRef","onChange","onReset","onSubmit","onValueChange","onSubmitFailure","validationSchema","schema","ajv","fieldMap","onlyValidateSchema"])
de("Render useForm")
var k=Object(n.useMemo)(function(){return{dontPreventDefault:t,initialValues:r,validate:i,validateFields:a,allowEmptyStrings:u,preventEnter:l,validationSchema:y,schema:b,ajv:g,fieldMap:m}},[t,r,i,a,u,l,y,b,g,m]),j=_slicedToArray(Object(n.useState)(function(){return new se(k)}),1)[0]
...
_(function(){var e=function onChangeHandler(){return f&&f(j.getFormState())},t=function onResetHandler(){return d&&d()},r=function onSubmitHandler(){return p&&p(j.getFormState().values)},n=function onValueHandler(){return h&&h(j.getFormState().values)},o=function onFailureHandler(){return v&&v(j.getFormState().errors)}
return j.on("change",e),j.on("reset",t),j.on("submit",r),j.on("value",n),j.on("failure",o),function(){j.removeListener("change",e),j.removeListener("reset",t),j.removeListener("submit",r),j.removeListener("value",n),j.removeListener("failure",o)}},[f,d,p,h,v]),Object(n.useState)(function(){j.on("change",function onChangeHandlerRerender(){de("Setting form state"),E(j.getFormState())}),s&&s(j.getFormApi()),c&&(c.current=j.getFormApi())})
var C=_slicedToArray(Object(n.useState)(function(){return j.getFormApi()}),1)[0]
return{formApi:C,formState:x,formController:j,render:function render(e){return o.a.createElement(fe,{formApi:C,formState:x,formController:j},o.a.createElement(o.a.Fragment,null,e||o.a.createElement(oe,{schema:b,onlyValidateSchema:O})))},userProps:w}},he=a("informed:Form\t\t"),ve=function Form(e){var t=e.children,r=e.render,n=e.component,i=_objectWithoutProperties(e,["children","render","component"])
he("Render FORM")
var a=pe(i),u=a.formApi,l=a.formController,s=a.formState,c=a.render,f=a.userProps
...
return Object(n.useMemo)(function(){return ye(t,e)},[e])}var be=function buildFieldState(e){return{value:e.getValue(),touched:e.getTouched(),error:e.getError()}}
...
void 0!==n&&(r[t]=n)})}),r}},Hc3C:function(e,t,r){"use strict"
var n=r("q1tI"),o=r.n(n),i=r("17x9"),a=r.n(i)
function _extends(){return(_extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]
for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e}).apply(this,arguments)}function _objectWithoutProperties(e,t){if(null==e)return{}
var r,n,o=function _objectWithoutPropertiesLoose(e,t){if(null==e)return{}
...
u.propTypes={color:a.a.string,size:a.a.oneOfType([a.a.string,a.a.number])},u.displayName="MinusCircle",t.a=u},Hdzk:function(e,t,r){"use strict"
var n=r("q1tI"),o=r.n(n),i=r("17x9"),a=r.n(i)
function _extends(){return(_extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]
for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e}).apply(this,arguments)}function _objectWithoutProperties(e,t){if(null==e)return{}
var r,n,o=function _objectWithoutPropertiesLoose(e,t){if(null==e)return{}
...
function sa(e){return!!T.call(A,e)||!T.call(L,e)&&(R.test(e)?A[e]=!0:(L[e]=!0,!1))}function M(e,t,r,n,o,i,a){this.acceptsBooleans=2===t||3===t||4===t,this.attributeName=n,this.attributeNamespace=o,this.mustUseProperty=r,this.propertyName=e,this.type=t,this.sanitizeURL=i,this.removeEmptyString=a}var D={}
...
u.propTypes={color:a.a.string,size:a.a.oneOfType([a.a.string,a.a.number])},u.displayName="ThumbsUp",t.a=u},M1Dp:function(e,t,r){"use strict"
var n=r("q1tI"),o=r.n(n),i=r("17x9"),a=r.n(i)
function _extends(){return(_extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]
for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e}).apply(this,arguments)}function _objectWithoutProperties(e,t){if(null==e)return{}
var r,n,o=function _objectWithoutPropertiesLoose(e,t){if(null==e)return{}
...
u.propTypes={color:a.a.string,size:a.a.oneOfType([a.a.string,a.a.number])},u.displayName="ThumbsDown",t.a=u},XmX0:function(e,t,r){"use strict"
var n=r("q1tI"),o=r.n(n),i=r("17x9"),a=r.n(i)
function _extends(){return(_extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]
for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e}).apply(this,arguments)}function _objectWithoutProperties(e,t){if(null==e)return{}
var r,n,o=function _objectWithoutPropertiesLoose(e,t){if(null==e)return{}
...
new Set
var O=r("uiNf"),w=r("M2J/"),k={dataIdFromObject:w.b,addTypename:!0,resultCaching:!0,typePolicies:{}},j=function(e){function InMemoryCache(t){void 0===t&&(t={})
...
var F=i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,R=60103,T=60106,L=60107,M=60108,D=60114,N=60109,z=60110,V=60112,Q=60113,q=60120,W=60115,U=60116,K=60121,$=60128,J=60129,X=60130,Y=60131
if("function"==typeof Symbol&&Symbol.for){var Z=Symbol.for
R=Z("react.element"),T=Z("react.portal"),L=Z("react.fragment"),M=Z("react.strict_mode"),D=Z("react.profiler"),N=Z("react.provider"),z=Z("react.context"),V=Z("react.forward_ref"),Q=Z("react.suspense"),q=Z("react.suspense_list"),W=Z("react.memo"),U=Z("react.lazy"),K=Z("react.block"),Z("react.scope"),$=Z("react.opaque.id"),J=Z("react.debug_trace_mode"),X=Z("react.offscreen"),Y=Z("react.legacy_hidden")}var ee,ie="function"==typeof Symbol&&Symbol.iterator
...
if("Unidentified"!==t)return t}return"keypress"===e.type?13===(e=od(e))?"Enter":String.fromCharCode(e):"keydown"===e.type||"keyup"===e.type?Bt[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:zd,charCode:function(e){return"keypress"===e.type?od(e):0},keyCode:function(e){return"keydown"===e.type||"keyup"===e.type?e.keyCode:0},which:function(e){return"keypress"===e.type?od(e):"keydown"===e.type||"keyup"===e.type?e.keyCode:0}})),Gt=rd(a({},Mt,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0})),Kt=rd(a({},Lt,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:zd})),$t=rd(a({},Rt,{propertyName:0,elapsedTime:0,pseudoElement:0})),Jt=rd(a({},Mt,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0})),Xt=[9,13,27,32],Yt=m&&"CompositionEvent"in window,Zt=null
...
function Bf(e){return{current:e}}function H(e){0>Ar||(e.current=Lr[Ar],Lr[Ar]=null,Ar--)}function I(e,t){Lr[++Ar]=e.current,e.current=t}var Mr={},Dr=Bf(Mr),Nr=Bf(!1),zr=Mr
...
Cn.length=0}var Pn=F.ReactCurrentDispatcher,_n=F.ReactCurrentBatchConfig,Fn=0,In=null,Rn=null,Tn=null,Ln=!1,An=!1
...
return!0}function Ch(e,t,r,n,o,i){if(Fn=i,In=t,t.memoizedState=null,t.updateQueue=null,t.lanes=0,Pn.current=null===e||null===e.memoizedState?Dn:Nn,e=r(n,o),An){i=0
do{if(An=!1,!(25>i))throw Error(y(301))
i+=1,Tn=Rn=null,t.updateQueue=null,Pn.current=zn,e=r(n,o)}while(An)}if(Pn.current=Mn,t=null!==Rn&&null!==Rn.next,Fn=0,Tn=Rn=In=null,Ln=!1,t)throw Error(y(300))
...
if(null===a?i.next=i:(i.next=a.next,a.next=i),t.pending=i,a=e.alternate,e===In||null!==a&&a===In)An=Ln=!0
...
function wj(){po=un()+500}var ho,vo=null,yo=!1,bo=null,go=null,mo=!1,Oo=null,wo=90,ko=[],jo=[],So=null,xo=0,Eo=null,Co=-1,Po=0,_o=0,Fo=null,Io=!1
...
null!==o&&(o.pending=null),n=n.next}Ln=!1}if(Fn=0,Tn=Rn=In=null,An=!1,Xn.current=null,null===r||null===r.return){oo=1,io=t,eo=null
...
lk(null,e,null,function(){t[Rr]=null})},We=function(e){13===e.tag&&(Jg(e,4,Hg()),ok(e,4))},He=function(e){13===e.tag&&(Jg(e,67108864,Hg()),ok(e,67108864))},Xe=function(e){if(13===e.tag){var t=Hg(),r=Ig(e)
...
if(!Ao.isDisabled&&Ao.supportsFiber)try{Vr=Ao.inject(Lo),Qr=Ao}catch(fe){}}r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Ro,r.createPortal=uk,r.findDOMNode=function(e){if(null==e)return null
