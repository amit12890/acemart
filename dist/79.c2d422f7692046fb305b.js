...
var n=r("J4zp"),a=r.n(n),i=r("q1tI"),l=r.n(i),o=r("kriW"),c=r("17x9"),s=r("xnu4"),u=r("VX74"),f=r("Ty5D"),d=r("OlZo"),p=r("y1Xp"),b=r("g4R5"),m=function init(e){return e instanceof Map?e:new Map},y=Object(b.a)(function reducer(e,t){var r=t.payload
...
return[r,Object(i.useMemo)(function(){return{addItem:l,clear:o,dispatch:n,removeItem:c,setItems:s,toggleItem:u}},[l,o,n,c,s,u])]}(),I=a()(F,2),x=I[0],_=I[1],A=Object(i.useRef)(null),M="filter"===g,C=Object(f.g)(),T=Object(f.h)(),E=T.pathname,L=T.search,H=Object(u.useQuery)(r).data,N=H?H.__type.inputFields:[],P=Object(i.useMemo)(function(){return t.map(function(e){return e.attribute_code})},[t]),R=Object(i.useMemo)(function(){var e=new Set
return"/search.html"!==E&&e.add("category_id"),e},[E]),z=Object(i.useMemo)(function(){var e,t=new Set,r=useFilterSidebar_createForOfIteratorHelper(N)
try{for(r.s();!(e=r.n()).done;){var n=e.value.name,a=P.includes(n),i=!R.has(n)
a&&i&&t.add(n)}}catch(e){r.e(e)}finally{r.f()}return t},[R,P,N]),B=Object(i.useMemo)(function(){var e,r=Object(j.a)(t,["label"],["asc"]),n=new Map,a=new Set,i=new Map,l=useFilterSidebar_createForOfIteratorHelper(r)
...
f.push({title:S(m),value:y,count:g})}}catch(e){p.e(e)}finally{p.f()}i.set(u,f)}}}catch(e){l.e(e)}finally{l.f()}return[n,a,i]},[t,z]),Q=a()(B,3),W=Q[0],Y=Q[1],D=Q[2]
...
i.append("".concat(d,"[filter]"),"".concat(m).concat(",").concat(y))}}catch(e){p.e(e)}finally{p.f()}}}catch(e){s.e(e)}finally{s.f()}return"?".concat(i.toString())}(L,Y,x)
C.push({pathname:E,search:e}),c(!1)}},[Y,x,C,o,E,L])
var J=Object(i.useCallback)(function(){w("filter")},[w]),K=Object(i.useCallback)(function(){O()},[O]),U=Object(i.useCallback)(function(){c(!0),K()},[K]),V=Object(i.useCallback)(function(){_.clear(),c(!0)},[_,c]),q=Object(i.useCallback)(function(e){if(M)switch(e.keyCode){case 27:K()}},[M,K])
return Object(i.useEffect)(function(){var e=null===A.current&&"filter"===g,t="filter"===A.current&&null===g
if(e||t){var r=h(L,Y,D)
_.setItems(r)}t&&K(),A.current=g},[g,_,D,Y,L,K]),Object(i.useEffect)(function(){var e=h(L,Y,D)
_.setItems(e)},[_,D,Y,L]),{filterApi:_,filterItems:D,filterKeys:Y,filterNames:W,filterState:x,handleApply:U,handleClose:K,handleKeyDownActions:q,handleOpen:J,handleReset:V,isApplying:o,isOpen:M}},I=r("fayf"),x=r("rXvQ"),_=r("VtMf"),A=r.n(_),M=r("se2u"),C=r("LboF"),T=r.n(C),E=r("5LYF"),L=r.n(E),H={injectType:"singletonStyleTag",insert:"head",singleton:!0},N=(T()(L.a,H),L.a.locals||{}),P={"--productLabel":'url("'.concat(A.a,'")')},R=function FilterSidebar(e){var t=e.filters,r=e.filterCountToOpen,n=F({filters:t}),c=n.filterApi,u=n.filterItems,f=n.filterNames,d=n.filterState,b=n.handleApply,m=n.handleReset,y=Object(i.useRef)(),g=Object(p.a)(N,e.classes),h=new Set(["on_sale","free_shipping","online_price","bulk_savings","new_item","disallow_pickupatstore"]),S=Object(i.useCallback)(function(){var e=y.current
if(e&&"function"==typeof e.getBoundingClientRect){var t=e.getBoundingClientRect().top,r=window.scrollY+t-150
window.scrollTo(0,r)}b.apply(void 0,arguments)},[b,y]),v=Object(i.useMemo)(function(){return Array.from(u,function(e,t){var r=a()(e,2),n=r[0],i=r[1]
if(!h.has(n)){var o=d.get(n),s=f.get(n)
return l.a.createElement(M.a,{key:n,filterApi:c,filterState:o,group:n,items:i,name:s,onApply:S,initialOpen:!0})}})},[c,u,f,d,r,S]),w=Object(i.useMemo)(function(){return Array.from(u,function(e,t){var r=a()(e,2),n=r[0]
r[1]
if(h.has(n)){var i=f.get(n)
return l.a.createElement("div",{className:g.labelItem},l.a.createElement("i",{className:g[Object(s.a)(n)],style:P}),l.a.createElement("span",{className:g.filterLabel},i))}})},[c,u,f,d,r,S]),O=d.size?l.a.createElement("div",{className:g.action},l.a.createElement(I.a,{type:"button",onClick:m},l.a.createElement(o.a,{id:"filterModal.action",defaultMessage:"Clear all"}))):null
return l.a.createElement(i.Fragment,null,l.a.createElement("aside",{className:g.root,ref:y},l.a.createElement("div",{className:g.body},l.a.createElement("div",{className:g.header},l.a.createElement("h2",{className:g.headerTitle},l.a.createElement(o.a,{id:"filterModal.headerTitle",defaultMessage:"Filters"}))),l.a.createElement(x.a,{filterApi:c,filterNames:f,filterState:d,onRemove:S}),O,l.a.createElement("ul",{className:g.blocks},v),l.a.createElement("div",{className:g.labelWrapper},w))))}
R.defaultProps={filterCountToOpen:3},R.propTypes={classes:Object(c.shape)({action:c.string,blocks:c.string,body:c.string,header:c.string,headerTitle:c.string,root:c.string,root_open:c.string}),filters:Object(c.arrayOf)(Object(c.shape)({attribute_code:c.string,items:c.array})),filterCountToOpen:c.number}
var z=R}}])
